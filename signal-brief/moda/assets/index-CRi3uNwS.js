 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(z,R){var b=z.length;z.push(R);e:for(;0<b;){var Z=b-1>>>1,le=z[Z];if(0<l(le,R))z[Z]=R,z[b]=le,b=Z;else break e}}function n(z){return z.length===0?null:z[0]}function r(z){if(z.length===0)return null;var R=z[0],b=z.pop();if(b!==R){z[0]=b;e:for(var Z=0,le=z.length,Pt=le>>>1;Z<Pt;){var Ce=2*(Z+1)-1,Jt=z[Ce],ct=Ce+1,qt=z[ct];if(0>l(Jt,b))ct<le&&0>l(qt,Jt)?(z[Z]=qt,z[ct]=b,Z=ct):(z[Z]=Jt,z[Ce]=b,Z=Ce);else if(ct<le&&0>l(qt,b))z[Z]=qt,z[ct]=b,Z=ct;else break e}}return R}function l(z,R){var b=z.sortIndex-R.sortIndex;return b!==0?b:z.id-R.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var i=Date,s=i.now();e.unstable_now=function(){return i.now()-s}}var a=[],f=[],v=1,y=null,g=3,S=!1,N=!1,_=!1,$=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function m(z){for(var R=n(f);R!==null;){if(R.callback===null)r(f);else if(R.startTime<=z)r(f),R.sortIndex=R.expirationTime,t(a,R);else break;R=n(f)}}function x(z){if(_=!1,m(z),!N)if(n(a)!==null)N=!0,se(E);else{var R=n(f);R!==null&&hn(x,R.startTime-z)}}function E(z,R){N=!1,_&&(_=!1,p(L),L=-1),S=!0;var b=g;try{for(m(R),y=n(a);y!==null&&(!(y.expirationTime>R)||z&&!fe());){var Z=y.callback;if(typeof Z=="function"){y.callback=null,g=y.priorityLevel;var le=Z(y.expirationTime<=R);R=e.unstable_now(),typeof le=="function"?y.callback=le:y===n(a)&&r(a),m(R)}else r(a);y=n(a)}if(y!==null)var Pt=!0;else{var Ce=n(f);Ce!==null&&hn(x,Ce.startTime-R),Pt=!1}return Pt}finally{y=null,g=b,S=!1}}var w=!1,P=null,L=-1,q=5,O=-1;function fe(){return!(e.unstable_now()-O<q)}function Pe(){if(P!==null){var z=e.unstable_now();O=z;var R=!0;try{R=P(!0,z)}finally{R?Xt():(w=!1,P=null)}}else w=!1}var Xt;if(typeof c=="function")Xt=function(){c(Pe)};else if(typeof MessageChannel<"u"){var Kn=new MessageChannel,ho=Kn.port2;Kn.port1.onmessage=Pe,Xt=function(){ho.postMessage(null)}}else Xt=function(){$(Pe,0)};function se(z){P=z,w||(w=!0,Xt())}function hn(z,R){L=$(function(){z(e.unstable_now())},R)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(z){z.callback=null},e.unstable_continueExecution=function(){N||S||(N=!0,se(E))},e.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):q=0<z?Math.floor(1e3/z):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return n(a)},e.unstable_next=function(z){switch(g){case 1:case 2:case 3:var R=3;break;default:R=g}var b=g;g=R;try{return z()}finally{g=b}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(z,R){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var b=g;g=z;try{return R()}finally{g=b}},e.unstable_scheduleCallback=function(z,R,b){var Z=e.unstable_now();switch(typeof b=="object"&&b!==null?(b=b.delay,b=typeof b=="number"&&0<b?Z+b:Z):b=Z,z){case 1:var le=-1;break;case 2:le=250;break;case 5:le=1073741823;break;case 4:le=1e4;break;default:le=5e3}return le=b+le,z={id:v++,callback:R,priorityLevel:z,startTime:b,expirationTime:le,sortIndex:-1},b>Z?(z.sortIndex=b,t(f,z),n(a)===null&&z===n(f)&&(_?(p(L),L=-1):_=!0,hn(x,b-Z))):(z.sortIndex=le,t(a,z),N||S||(N=!0,se(E))),z},e.unstable_shouldYield=fe,e.unstable_wrapCallback=function(z){var R=g;return function(){var b=g;g=R;try{return z.apply(this,arguments)}finally{g=b}}}})(Lu);Iu.exports=Lu;var jf=Iu.exports;/**
 * @license React
...
`}};const Ar=Tm,Mm=Ar.thinkers,Im=Ar.sources,tn=Ar.branding,fo=Ar.prompts,lr=Ar.council;function po(e,t){return Object.entries(t).reduce((n,[r,l])=>n.replaceAll(`{${r}}`,String(l??"")),e)}const Lm="/claude",Dm="https://stelle-972218119922.europe-west1.run.app/api",Ld=Dm;async function mo(e){const t=await fetch(Lm,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({prompt:e})});if(!(t.headers.get("content-type")||"").includes("application/json")){const l=(await t.text()).slice(0,60).replace(/\s+/g," ");throw new Error(`Backend Claude non raggiungibile (${t.status}). Questa funzione è disponibile solo col dev server locale. Risposta: ${l}…`)}const r=await t.json();if(!t.ok)throw new Error(r.error||"Claude CLI error");return r}function Om(e){const t=Object.values(e);return t.length>0&&t.some(n=>!n.startsWith("Errore"))}async function Rm(e){const t=po(fo.scan,{thinker_name:e.name,thinker_handle:e.handle});return(await mo(t)).text||"Nessun contenuto estratto."}async function mu(e){const t=e.map(l=>`### ${l.name} (${l.domain})
${l.content}`).join(`
...
`);x.push({title:"Progetti Emergenti",text:E,type:"projects"})}v(x)},[v]),_=T.useCallback(($,p)=>{v([{title:$,text:p,type:"single"}])},[v]);return T.useEffect(()=>()=>speechSynthesis.cancel(),[]),{isPlaying:e,currentChapter:n,chapters:l,playAll:N,playSingle:_,pause:y,resume:g,stop:f,skipForward:S}}const Ym=`
