...
`);S.push({title:"Progetti Emergenti",text:z,type:"projects"})}y(S)},[y]),C=T.useCallback((F,f)=>{y([{title:F,text:f,type:"single"}])},[y]);return T.useEffect(()=>()=>speechSynthesis.cancel(),[]),{isPlaying:e,currentChapter:n,chapters:o,playAll:k,playSingle:C,pause:v,resume:h,stop:d,skipForward:w}}const nr=Wn?`?theme=${Wn}`:"",ag=`
