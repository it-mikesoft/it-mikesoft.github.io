(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))r(l);new MutationObserver(l=>{for(const o of l)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function n(l){const o={};return l.integrity&&(o.integrity=l.integrity),l.referrerPolicy&&(o.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?o.credentials="include":l.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(l){if(l.ep)return;l.ep=!0;const o=n(l);fetch(l.href,o)}})();var zu={exports:{}},ql={},_u={exports:{}},H={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Cf=z,Ef=Symbol.for("react.element"),zf=Symbol.for("react.fragment"),_f=Object.prototype.hasOwnProperty,Pf=Cf.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Mf={key:!0,ref:!0,__self:!0,__source:!0};function Ou(e,t,n){var r,l={},o=null,i=null;n!==void 0&&(o=""+n),t.key!==void 0&&(o=""+t.key),t.ref!==void 0&&(i=t.ref);for(r in t)_f.call(t,r)&&!Mf.hasOwnProperty(r)&&(l[r]=t[r]);if(e&&e.defaultProps)for(r in t=e.defaultProps,t)l[r]===void 0&&(l[r]=t[r]);return{$$typeof:Ef,type:e,key:o,ref:i,props:l,_owner:Pf.current}}ql.Fragment=zf;ql.jsx=Ou;ql.jsxs=Ou;zu.exports=ql;var u=zu.exports,Fu={exports:{}},We={},$u={exports:{}},Au={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(P,O){var D=P.length;P.push(O);e:for(;0<D;){var ee=D-1>>>1,Y=P[ee];if(0<l(Y,O))P[ee]=O,P[D]=Y,D=ee;else break e}}function n(P){return P.length===0?null:P[0]}function r(P){if(P.length===0)return null;var O=P[0],D=P.pop();if(D!==O){P[0]=D;e:for(var ee=0,Y=P.length,en=Y>>>1;ee<en;){var Ke=2*(ee+1)-1,yn=P[Ke],tt=Ke+1,It=P[tt];if(0>l(yn,D))tt<Y&&0>l(It,yn)?(P[ee]=It,P[tt]=D,ee=tt):(P[ee]=yn,P[Ke]=D,ee=Ke);else if(tt<Y&&0>l(It,D))P[ee]=It,P[tt]=D,ee=tt;else break e}}return O}function l(P,O){var D=P.sortIndex-O.sortIndex;return D!==0?D:P.id-O.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var i=Date,s=i.now();e.unstable_now=function(){return i.now()-s}}var a=[],f=[],v=1,y=null,g=3,S=!1,j=!1,_=!1,U=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function m(P){for(var O=n(f);O!==null;){if(O.callback===null)r(f);else if(O.startTime<=P)r(f),O.sortIndex=O.expirationTime,t(a,O);else break;O=n(f)}}function x(P){if(_=!1,m(P),!j)if(n(a)!==null)j=!0,Ae(E);else{var O=n(f);O!==null&&Gn(x,O.startTime-P)}}function E(P,O){j=!1,_&&(_=!1,p(b),b=-1),S=!0;var D=g;try{for(m(O),y=n(a);y!==null&&(!(y.expirationTime>O)||P&&!ve());){var ee=y.callback;if(typeof ee=="function"){y.callback=null,g=y.priorityLevel;var Y=ee(y.expirationTime<=O);O=e.unstable_now(),typeof Y=="function"?y.callback=Y:y===n(a)&&r(a),m(O)}else r(a);y=n(a)}if(y!==null)var en=!0;else{var Ke=n(f);Ke!==null&&Gn(x,Ke.startTime-O),en=!1}return en}finally{y=null,g=D,S=!1}}var N=!1,M=null,b=-1,ne=5,I=-1;function ve(){return!(e.unstable_now()-I<ne)}function Mt(){if(M!==null){var P=e.unstable_now();I=P;var O=!0;try{O=M(!0,P)}finally{O?Tt():(N=!1,M=null)}}else N=!1}var Tt;if(typeof c=="function")Tt=function(){c(Mt)};else if(typeof MessageChannel<"u"){var _e=new MessageChannel,gt=_e.port2;_e.port1.onmessage=Mt,Tt=function(){gt.postMessage(null)}}else Tt=function(){U(Mt,0)};function Ae(P){M=P,N||(N=!0,Tt())}function Gn(P,O){b=U(function(){P(e.unstable_now())},O)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(P){P.callback=null},e.unstable_continueExecution=function(){j||S||(j=!0,Ae(E))},e.unstable_forceFrameRate=function(P){0>P||125<P?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ne=0<P?Math.floor(1e3/P):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return n(a)},e.unstable_next=function(P){switch(g){case 1:case 2:case 3:var O=3;break;default:O=g}var D=g;g=O;try{return P()}finally{g=D}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(P,O){switch(P){case 1:case 2:case 3:case 4:case 5:break;default:P=3}var D=g;g=P;try{return O()}finally{g=D}},e.unstable_scheduleCallback=function(P,O,D){var ee=e.unstable_now();switch(typeof D=="object"&&D!==null?(D=D.delay,D=typeof D=="number"&&0<D?ee+D:ee):D=ee,P){case 1:var Y=-1;break;case 2:Y=250;break;case 5:Y=1073741823;break;case 4:Y=1e4;break;default:Y=5e3}return Y=D+Y,P={id:v++,callback:O,priorityLevel:P,startTime:D,expirationTime:Y,sortIndex:-1},D>ee?(P.sortIndex=D,t(f,P),n(a)===null&&P===n(f)&&(_?(p(b),b=-1):_=!0,Gn(x,D-ee))):(P.sortIndex=Y,t(a,P),j||S||(j=!0,Ae(E))),P},e.unstable_shouldYield=ve,e.unstable_wrapCallback=function(P){var O=g;return function(){var D=g;g=O;try{return P.apply(this,arguments)}finally{g=D}}}})(Au);$u.exports=Au;var Tf=$u.exports;/**
 * @license React
...
`);x.push({title:"Progetti Emergenti",text:E,type:"projects"})}v(x)},[v]),_=z.useCallback((U,p)=>{v([{title:U,text:p,type:"single"}])},[v]);return z.useEffect(()=>()=>speechSynthesis.cancel(),[]),{isPlaying:e,currentChapter:n,chapters:l,playAll:j,playSingle:_,pause:y,resume:g,stop:f,skipForward:S}}const eh=`
