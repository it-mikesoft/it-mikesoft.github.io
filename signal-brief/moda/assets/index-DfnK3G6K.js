 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(_,R){var O=_.length;_.push(R);e:for(;0<O;){var Z=O-1>>>1,oe=_[Z];if(0<o(oe,R))_[Z]=R,_[O]=oe,O=Z;else break e}}function n(_){return _.length===0?null:_[0]}function r(_){if(_.length===0)return null;var R=_[0],O=_.pop();if(O!==R){_[0]=O;e:for(var Z=0,oe=_.length,Tt=oe>>>1;Z<Tt;){var Ce=2*(Z+1)-1,Jt=_[Ce],dt=Ce+1,Zt=_[dt];if(0>o(Jt,O))dt<oe&&0>o(Zt,Jt)?(_[Z]=Zt,_[dt]=O,Z=dt):(_[Z]=Jt,_[Ce]=O,Z=Ce);else if(dt<oe&&0>o(Zt,O))_[Z]=Zt,_[dt]=O,Z=dt;else break e}}return R}function o(_,R){var O=_.sortIndex-R.sortIndex;return O!==0?O:_.id-R.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var i=Date,s=i.now();e.unstable_now=function(){return i.now()-s}}var a=[],f=[],y=1,v=null,g=3,S=!1,N=!1,z=!1,$=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function m(_){for(var R=n(f);R!==null;){if(R.callback===null)r(f);else if(R.startTime<=_)r(f),R.sortIndex=R.expirationTime,t(a,R);else break;R=n(f)}}function x(_){if(z=!1,m(_),!N)if(n(a)!==null)N=!0,se(E);else{var R=n(f);R!==null&&hn(x,R.startTime-_)}}function E(_,R){N=!1,z&&(z=!1,p(I),I=-1),S=!0;var O=g;try{for(m(R),v=n(a);v!==null&&(!(v.expirationTime>R)||_&&!fe());){var Z=v.callback;if(typeof Z=="function"){v.callback=null,g=v.priorityLevel;var oe=Z(v.expirationTime<=R);R=e.unstable_now(),typeof oe=="function"?v.callback=oe:v===n(a)&&r(a),m(R)}else r(a);v=n(a)}if(v!==null)var Tt=!0;else{var Ce=n(f);Ce!==null&&hn(x,Ce.startTime-R),Tt=!1}return Tt}finally{v=null,g=O,S=!1}}var w=!1,T=null,I=-1,J=5,D=-1;function fe(){return!(e.unstable_now()-D<J)}function Te(){if(T!==null){var _=e.unstable_now();D=_;var R=!0;try{R=T(!0,_)}finally{R?qt():(w=!1,T=null)}}else w=!1}var qt;if(typeof c=="function")qt=function(){c(Te)};else if(typeof MessageChannel<"u"){var Kn=new MessageChannel,hl=Kn.port2;Kn.port1.onmessage=Te,qt=function(){hl.postMessage(null)}}else qt=function(){$(Te,0)};function se(_){T=_,w||(w=!0,qt())}function hn(_,R){I=$(function(){_(e.unstable_now())},R)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(_){_.callback=null},e.unstable_continueExecution=function(){N||S||(N=!0,se(E))},e.unstable_forceFrameRate=function(_){0>_||125<_?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):J=0<_?Math.floor(1e3/_):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return n(a)},e.unstable_next=function(_){switch(g){case 1:case 2:case 3:var R=3;break;default:R=g}var O=g;g=R;try{return _()}finally{g=O}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(_,R){switch(_){case 1:case 2:case 3:case 4:case 5:break;default:_=3}var O=g;g=_;try{return R()}finally{g=O}},e.unstable_scheduleCallback=function(_,R,O){var Z=e.unstable_now();switch(typeof O=="object"&&O!==null?(O=O.delay,O=typeof O=="number"&&0<O?Z+O:Z):O=Z,_){case 1:var oe=-1;break;case 2:oe=250;break;case 5:oe=1073741823;break;case 4:oe=1e4;break;default:oe=5e3}return oe=O+oe,_={id:y++,callback:R,priorityLevel:_,startTime:O,expirationTime:oe,sortIndex:-1},O>Z?(_.sortIndex=O,t(f,_),n(a)===null&&_===n(f)&&(z?(p(I),I=-1):z=!0,hn(x,O-Z))):(_.sortIndex=oe,t(a,_),N||S||(N=!0,se(E))),_},e.unstable_shouldYield=fe,e.unstable_wrapCallback=function(_){var R=g;return function(){var O=g;g=R;try{return _.apply(this,arguments)}finally{g=O}}}})(Iu);bu.exports=Iu;var Ef=bu.exports;/**
 * @license React
...
`;function Jm(){const[e,t]=P.useState(bm),[n,r]=P.useState({}),[o,l]=P.useState({}),[i,s]=P.useState({}),[a,f]=P.useState(null),[y,v]=P.useState("idle"),[g,S]=P.useState(!1),[N,z]=P.useState(""),[$,p]=P.useState(""),[c,m]=P.useState(null),[x,E]=P.useState(!1),[w,T]=P.useState([]),[I,J]=P.useState(null),[D,fe]=P.useState("signals"),[Te,qt]=P.useState({leftIdx:1,rightIdx:0}),[Kn,hl]=P.useState("emerging"),[se,hn]=P.useState([]),[_,R]=P.useState([]),[O,Z]=P.useState(null),[oe,Tt]=P.useState("idle"),[Ce,Jt]=P.useState(Im),[dt,Zt]=P.useState(""),[Ld,gl]=P.useState(!1),[Bs,Dd]=P.useState(!1),[gn,Rd]=P.useState(""),[Br,Us]=P.useState([]),[Ur,vl]=P.useState("idle"),[Od,Hs]=P.useState(!1),[Hr,yl]=P.useState(null),[Vs,Ws]=P.useState(null),[Zm,eh]=P.useState("idle"),[Qs,Fd]=P.useState({scan:"",launchd:""}),[Vr,xl]=P.useState("idle"),[th,Ks]=P.useState([]),[$d,Ad]=P.useState({}),[Bd,Ud]=P.useState(new Set),wl=P.useRef(null),ge=Ym(),[Hd,Vd]=P.useState(()=>new Date().toLocaleString("it-IT",{dateStyle:"short",timeStyle:"short"})),xe=e.filter(d=>d.active),Ys=xe.filter(d=>!d.fontiOnly),vn=Object.values(i).filter(d=>d==="done"||d==="stale").length,kl=xe.length;P.useEffect(()=>{(async()=>{try{const d=await window.storage.get("signal-state");if(d){const h=JSON.parse(d.value);if(h.results){r(h.results);const C=new Set((h.staleIds||[]).map(String)),b={};for(const U of Object.keys(h.results))h.results[U].startsWith("Errore")?b[U]="error":C.has(String(U))?b[U]="stale":b[U]="done";s(b),h.staleIds&&Ks(h.staleIds)}if(h.prevResults&&l(h.prevResults),h.lastScanTime&&m(h.lastScanTime),h.synthesis&&(f(h.synthesis),v("done")),h.synthesisHistory){const C=h.synthesisHistory.map((b,U,Q)=>{if(b.conceptDiff&&!b.conceptDiffs){const we=Q[U+1],{conceptDiff:Oe,...qe}=b;return we?{...qe,conceptDiffs:{[we.id]:Oe}}:qe}return b});T(C)}h.projects&&hn(h.projects),h.prevProjects&&R(h.prevProjects),h.projectsTime&&Z(h.projectsTime),h.projectSources&&Jt(h.projectSources)}}catch{}})()},[]);const Me=P.useCallback(async(d={})=>{try{const h=await window.storage.get("signal-state"),b={...h?JSON.parse(h.value):{},...d};await window.storage.set("signal-state",JSON.stringify(b))}catch{}},[]);P.useCallback(async(d={})=>{await Me({results:n,prevResults:o,lastScanTime:c,synthesis:a,synthesisHistory:w,projects:se,prevProjects:_,projectsTime:O,projectSources:Ce,...d})},[n,o,c,a,w,se,_,O,Ce,Me]);const Wr=P.useCallback((d,h)=>h.length>0&&h[0].text===d?h:[{id:`synth_${Date.now()}`,timestamp:Date.now(),text:d,thinkers:xe.map(b=>b.name),conceptDiffs:{}},...h].slice(0,50),[xe]),Qr=P.useCallback(async d=>{var b;if(d.length<2)return d;const h=d[0],C=d[1];if((b=h.conceptDiffs)!=null&&b[C.id])return d;try{const U=await Am(C.text,h.text),Q=[...d];return Q[0]={...Q[0],conceptDiffs:{...Q[0].conceptDiffs||{},[C.id]:U}},T(Q),await Me({synthesisHistory:Q}),Q}catch(U){return console.error("[concept-diff auto]",U),d}},[Me]),Gs=P.useCallback(async(d,h)=>{try{await navigator.clipboard.writeText(d)}catch{const C=document.createElement("textarea");C.value=d,document.body.appendChild(C),C.select(),document.execCommand("copy"),document.body.removeChild(C)}J(h),setTimeout(()=>J(null),2e3)},[]);P.useCallback(async d=>{const h=w.filter(C=>C.id!==d);T(h),await Me({synthesisHistory:h})},[w,Me]);const Sl=P.useCallback(async()=>{xl("loading");const d="/signal-brief/moda/";try{const[h,C]=await Promise.all([fetch(`${d}logs/auto-scan.log`,{cache:"no-cache"}),fetch(`${d}logs/launchd-out.log`,{cache:"no-cache"})]),b=h.ok?await h.text():"",U=C.ok?await C.text():"";Fd({scan:b,launchd:U}),xl("done")}catch(h){console.error("[logs]",h),xl("error")}},[]);P.useEffect(()=>{D==="log"&&Sl()},[D,Sl]);const Xs=P.useCallback(d=>{if(!d)return;const h=d.trim().toLowerCase();if(!h)return;const C=e.find(b=>{const U=b.name.toLowerCase();return U===h||U.includes(h)||h.includes(U)});C&&(fe("signals"),E(!1),setTimeout(()=>{const b=document.getElementById(`thinker-${C.id}`);b&&(b.scrollIntoView({behavior:"smooth",block:"start"}),b.classList.add("thinker-card-highlight"),setTimeout(()=>b.classList.remove("thinker-card-highlight"),1800))},60))},[e]),Wd=(d,h)=>{if(!d||!h)return 0;const C=new Set(d.toLowerCase().split(/\s+/)),b=new Set(h.toLowerCase().split(/\s+/));return[...C].filter(Q=>b.has(Q)).length/Math.max(C.size,b.size)},qs=d=>!o[d]||!n[d]?!1:Wd(o[d],n[d])<.72;xe.filter(d=>i[d.id]==="done"&&qs(d.id)).length;const Js=e.length>0&&e.every(d=>d.active),Qd=()=>{g||t(d=>d.map(h=>({...h,active:!Js})))},Nl=()=>{N.trim()&&(t(d=>[...d,{id:Date.now(),name:N.trim(),handle:$.trim()||"@?",domain:"Custom",active:!0}]),z(""),p(""))},Zs=()=>{const d=dt.trim();if(!d||Ce.includes(d))return;const h=[...Ce,d];Jt(h),Zt(""),Me({projectSources:h})},Kd=d=>{const h=Ce.filter(C=>C!==d);Jt(h),Me({projectSources:h})},[Yd,ea]=P.useState(null),Kr=P.useCallback(async(d,h)=>{Tt("loading"),ea(null);try{const C=await $m(h,d,Ce);R(se),hn(C);const b=Date.now();Z(b),Tt("done"),await Me({projects:C,prevProjects:se,projectsTime:b})}catch(C){console.error("[Signal.Brief] fetchProjects error:",C),Tt("error"),ea(C.message)}},[Ce,Me,se]),Gd=P.useCallback(async()=>{if(xe.length===0)return;fe("signals"),S(!0),f(null),v("idle"),l(B=>({...B,...n}));const d={...n},h={};for(const B of xe){const ae=d[B.id];ae&&!ae.startsWith("Errore")&&(h[B.id]=ae)}const C={};xe.forEach(B=>{C[B.id]="loading"}),s(C),r(h);const b={...h},U=[],Q={},we=2,Oe=B=>new Promise(ae=>setTimeout(ae,B));for(let B=0;B<xe.length;B+=we){const ae=xe.slice(B,B+we);await Promise.all(ae.map(async be=>{try{const H=await Fm(be);b[be.id]=H,r(le=>({...le,[be.id]:H})),s(le=>({...le,[be.id]:"done"}))}catch(H){const le=h[be.id]!=null;Q[be.id]=H.message,le?(U.push(String(be.id)),s(ue=>({...ue,[be.id]:"stale"}))):(b[be.id]=`Errore: ${H.message}`,r(ue=>({...ue,[be.id]:`Errore: ${H.message}`})),s(ue=>({...ue,[be.id]:"error"})))}})),B+we<xe.length&&await Oe(1200)}Ks(U),Ad(Q);const qe=Om(b),Ve=qe?Date.now():c;qe&&(m(Ve),Vd(new Date().toLocaleString("it-IT",{dateStyle:"short",timeStyle:"short"}))),await Me({results:b,prevResults:d,lastScanTime:Ve,synthesis:a,synthesisHistory:w,staleIds:U}),S(!1);const Fe=Ys.filter(B=>b[B.id]&&!b[B.id].startsWith("Errore")).map(B=>({name:B.name,domain:B.domain,content:b[B.id]}));if(Fe.length>=2){v("loading");try{const B=await hu(Fe);f(B),v("done");const ae=Wr(B,w);T(ae),await Me({results:b,prevResults:d,lastScanTime:Ve,synthesis:B,synthesisHistory:ae}),Qr(ae),Kr(B,Fe)}catch{v("error")}}},[xe,n,Me,a,w,Wr,c,Kr,Qr]),Xd=P.useCallback(async()=>{const d=Ys.filter(h=>i[h.id]==="done"||i[h.id]==="stale").map(h=>({name:h.name,domain:h.domain,content:n[h.id]}));if(!(d.length<2)){v("loading");try{const h=await hu(d);f(h),v("done");const C=Wr(h,w);T(C),await Me({synthesis:h,synthesisHistory:C}),Qr(C),Kr(h,d)}catch(h){f(`Errore nella sintesi: ${h.message}`),v("error")}}},[xe,i,n,Me,w,Wr,Kr,Qr]),ta=P.useCallback(async()=>{if(gn.trim()){Us([]),yl(null),Ws(null),vl("loading"),Hs(!1);try{await Bm(gn,a,(d,h)=>{if(d==="session_started"&&h.session_id&&Ws(h.session_id),d==="sage_speaks"&&h.content&&Us(C=>[...C,{name:h.persona_name,icon:h.persona_icon,color:h.persona_color,content:h.content}]),d==="moderator_synthesis"&&h.content&&yl(h.content),d==="moderator"){const C=h.content||h.decision||h.synthesis||"";C&&yl(C)}}),vl("done")}catch(d){console.error("[council]",d),d.message==="auth_required"&&Hs(!0),vl("error")}}},[gn,a]),qd=vn>=2&&!g&&y!=="loading",na=Object.keys(n).length>0,ra="Disponibile solo in locale (richiede Claude CLI)",Jd=xe.filter(d=>{if(!i[d.id])return!1;if(x){const h=i[d.id];return(h==="done"||h==="stale")&&qs(d.id)}return!0});return u.jsxs(u.Fragment,{children:[u.jsx("style",{children:qm}),u.jsxs("div",{className:"dashboard",children:[u.jsx("div",{className:"scanline"}),u.jsxs("header",{className:"header",children:[u.jsxs("div",{className:"header-top",children:[u.jsxs("div",{className:"header-left",children:[u.jsx("div",{className:"logo",style:{cursor:"pointer"},onClick:()=>gl(!0),dangerouslySetInnerHTML:{__html:Se.nameHtml}}),u.jsx("div",{className:"tagline",children:Se.tagline})]}),u.jsxs("div",{className:"header-right",children:[c&&u.jsxs("span",{className:"timestamp",children:["ultimo: ",Hd]}),u.jsx("button",{className:"btn btn-synthesis btn-small",onClick:Xd,disabled:!qd||!0,title:ra,children:"◈ Synth"}),u.jsx("button",{className:"btn btn-ghost btn-small",onClick:()=>{if(!wl.current){const h=new Audio(`/signal-brief/moda/podcast/episodes/${new Date().toISOString().slice(0,10)}.mp3`);h.onerror=()=>{h.src="/signal-brief/moda/podcast/episodes/2026-04-12.mp3",h.play()},wl.current=h}const d=wl.current;d.paused?d.play():d.pause()},title:"Ascolta l'ultimo episodio",children:"🎙 Podcast"}),u.jsx("a",{className:"btn btn-ghost btn-small",href:"/signal-brief/moda/podcast/",title:"Archivio puntate con testo, sintesi, comparazione e fonti",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:"☰ Archivio"}),u.jsx("button",{className:"btn btn-primary",onClick:()=>Gd(),disabled:g||xe.length===0||!0,title:ra,children:g?`Scanning ${vn}/${kl}…`:"▶ Scan"})]})]}),u.jsxs("nav",{className:"tab-bar",children:[u.jsxs("button",{className:`tab-btn ${D==="signals"?"active":""}`,onClick:()=>fe("signals"),children:["Segnali",vn>0&&u.jsx("span",{className:"tab-badge",children:vn})]}),u.jsxs("button",{className:`tab-btn ${D==="projects"?"active":""}`,onClick:()=>fe("projects"),children:["Progetti",se.length>0&&u.jsx("span",{className:"tab-badge",children:se.length})]}),u.jsxs("button",{className:`tab-btn ${D==="history"?"active":""}`,onClick:()=>fe("history"),children:["Cronologia",w.length>0&&u.jsx("span",{className:"tab-badge",children:w.length})]}),u.jsx("button",{className:`tab-btn ${D==="log"?"active":""}`,onClick:()=>fe("log"),children:"▤ Log"}),u.jsx("button",{className:`tab-btn ${D==="config"?"active":""}`,onClick:()=>fe("config"),children:"⚙ Configurazione"})]})]}),u.jsxs("div",{className:"tab-content",children:[D==="signals"&&u.jsxs(u.Fragment,{children:[g&&u.jsx("div",{className:"progress-bar",children:u.jsx("div",{className:"progress-fill",style:{width:`${kl>0?vn/kl*100:0}%`}})}),(a||y==="loading")&&u.jsxs("div",{className:"synthesis-panel",children:[u.jsxs("div",{className:"synthesis-header",children:[u.jsx("span",{className:"synthesis-label",children:"◈ Cross-Synthesis"}),u.jsx("span",{className:"synthesis-title",children:y==="loading"?"Elaborazione…":"Temi emergenti trasversali"}),y==="done"&&w.length>0&&u.jsx("span",{className:"timestamp",children:new Date(w[0].timestamp).toLocaleString("it-IT",{dateStyle:"short",timeStyle:"short"})}),y==="done"&&u.jsxs("div",{className:"synthesis-actions",children:[u.jsx("button",{className:"btn-listen",onClick:()=>ge.playSingle("Cross-Synthesis",a),title:"Ascolta",children:"🔊"}),u.jsx("button",{className:"btn btn-ghost btn-small",onClick:()=>Dd(d=>!d),title:"Chiedi ai thinkers",style:Bs?{background:"#ede9fe",color:"#7c3aed",borderColor:"#d8b4fe"}:{},children:"📡 Chiedi"}),u.jsx("button",{className:"btn btn-ghost btn-small",onClick:()=>Gs(a,"synth"),children:I==="synth"?"Copiato ✓":"Copia ❐"})]})]}),y==="loading"?u.jsxs("div",{className:"card-loading-state",children:[u.jsx("div",{className:"spinner"}),"Analisi in corso…"]}):u.jsx("div",{className:"synthesis-body",dangerouslySetInnerHTML:{__html:Wm(w.length>1?Vm(a,w[1].text):jt(a),xe)}}),Bs&&y==="done"&&u.jsxs("div",{className:"council-panel",children:[u.jsxs("div",{className:"council-header",children:[Vs?u.jsx("a",{className:"council-label",href:`https://stelle-972218119922.europe-west1.run.app/?context=session:${Vs}`,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",cursor:"pointer"},children:"📡 Assemblea Signal-Brief ↗"}):u.jsx("span",{className:"council-label",children:"📡 Assemblea Signal-Brief"}),u.jsx("span",{style:{fontFamily:"IBM Plex Mono,monospace",fontSize:10,color:"var(--sb-text-muted)"},children:"21 thinker · Summon Stars"})]}),u.jsxs("div",{className:"council-input-row",children:[u.jsx("input",{className:"council-input",placeholder:"Fai una domanda ai thinkers...",value:gn,onChange:d=>Rd(d.target.value),onKeyDown:d=>d.key==="Enter"&&ta(),disabled:Ur==="loading"}),u.jsx("button",{className:"btn btn-primary btn-small",onClick:ta,disabled:Ur==="loading"||!gn.trim(),children:Ur==="loading"?"In deliberazione…":"Chiedi"})]}),Br.length>0&&u.jsx("div",{style:{maxHeight:400,overflowY:"auto"},children:Br.map((d,h)=>u.jsxs("div",{className:"council-msg",children:[u.jsxs("div",{className:"council-msg-name",style:{color:d.color},children:[d.icon," ",d.name]}),u.jsx("div",{children:d.content})]},h))}),Hr&&u.jsxs("div",{className:"council-synthesis",children:[u.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between"},children:[u.jsx("div",{className:"council-synthesis-label",children:"Sintesi del moderatore"}),u.jsxs("div",{style:{display:"flex",gap:4},children:[u.jsx("button",{className:"btn-listen",onClick:()=>{const d=Br.map(h=>`${h.name}: ${h.content}`).join(`
