 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(w,j){var _=w.length;w.push(j);e:for(;0<_;){var ee=_-1>>>1,ae=w[ee];if(0<o(ae,j))w[ee]=j,w[_]=ae,_=ee;else break e}}function n(w){return w.length===0?null:w[0]}function i(w){if(w.length===0)return null;var j=w[0],_=w.pop();if(_!==j){w[0]=_;e:for(var ee=0,ae=w.length,Tt=ae>>>1;ee<Tt;){var Ie=2*(ee+1)-1,Jt=w[Ie],dt=Ie+1,Zt=w[dt];if(0>o(Jt,_))dt<ae&&0>o(Zt,Jt)?(w[ee]=Zt,w[dt]=_,ee=dt):(w[ee]=Jt,w[Ie]=_,ee=Ie);else if(dt<ae&&0>o(Zt,_))w[ee]=Zt,w[dt]=_,ee=dt;else break e}}return j}function o(w,j){var _=w.sortIndex-j.sortIndex;return _!==0?_:w.id-j.id}if(typeof performance=="object"&&typeof performance.now=="function"){var a=performance;e.unstable_now=function(){return a.now()}}else{var r=Date,l=r.now();e.unstable_now=function(){return r.now()-l}}var s=[],d=[],y=1,v=null,h=3,b=!1,z=!1,C=!1,F=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,u=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function f(w){for(var j=n(d);j!==null;){if(j.callback===null)i(d);else if(j.startTime<=w)i(d),j.sortIndex=j.expirationTime,t(s,j);else break;j=n(d)}}function S(w){if(C=!1,f(w),!z)if(n(s)!==null)z=!0,se(k);else{var j=n(d);j!==null&&yn(S,j.startTime-w)}}function k(w,j){z=!1,C&&(C=!1,m(O),O=-1),b=!0;var _=h;try{for(f(j),v=n(s);v!==null&&(!(v.expirationTime>j)||w&&!pe());){var ee=v.callback;if(typeof ee=="function"){v.callback=null,h=v.priorityLevel;var ae=ee(v.expirationTime<=j);j=e.unstable_now(),typeof ae=="function"?v.callback=ae:v===n(s)&&i(s),f(j)}else i(s);v=n(s)}if(v!==null)var Tt=!0;else{var Ie=n(d);Ie!==null&&yn(S,Ie.startTime-j),Tt=!1}return Tt}finally{v=null,h=_,b=!1}}var x=!1,P=null,O=-1,X=5,L=-1;function pe(){return!(e.unstable_now()-L<X)}function Pe(){if(P!==null){var w=e.unstable_now();L=w;var j=!0;try{j=P(!0,w)}finally{j?Yt():(x=!1,P=null)}}else x=!1}var Yt;if(typeof u=="function")Yt=function(){u(Pe)};else if(typeof MessageChannel<"u"){var Jn=new MessageChannel,va=Jn.port2;Jn.port1.onmessage=Pe,Yt=function(){va.postMessage(null)}}else Yt=function(){F(Pe,0)};function se(w){P=w,x||(x=!0,Yt())}function yn(w,j){O=F(function(){w(e.unstable_now())},j)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(w){w.callback=null},e.unstable_continueExecution=function(){z||b||(z=!0,se(k))},e.unstable_forceFrameRate=function(w){0>w||125<w?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):X=0<w?Math.floor(1e3/w):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(w){switch(h){case 1:case 2:case 3:var j=3;break;default:j=h}var _=h;h=j;try{return w()}finally{h=_}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(w,j){switch(w){case 1:case 2:case 3:case 4:case 5:break;default:w=3}var _=h;h=w;try{return j()}finally{h=_}},e.unstable_scheduleCallback=function(w,j,_){var ee=e.unstable_now();switch(typeof _=="object"&&_!==null?(_=_.delay,_=typeof _=="number"&&0<_?ee+_:ee):_=ee,w){case 1:var ae=-1;break;case 2:ae=250;break;case 5:ae=1073741823;break;case 4:ae=1e4;break;default:ae=5e3}return ae=_+ae,w={id:y++,callback:j,priorityLevel:w,startTime:_,expirationTime:ae,sortIndex:-1},_>ee?(w.sortIndex=_,t(d,w),n(s)===null&&w===n(d)&&(C?(m(O),O=-1):C=!0,yn(S,_-ee))):(w.sortIndex=ae,t(s,w),z||b||(z=!0,se(k))),w},e.unstable_shouldYield=pe,e.unstable_wrapCallback=function(w){var j=h;return function(){var _=h;h=j;try{return w.apply(this,arguments)}finally{h=_}}}})(Dc);_c.exports=Dc;var Op=_c.exports;/**
 * @license React
...
`).trim():""}function ng(){const[e,t]=T.useState(!1),[n,i]=T.useState(-1),[o,a]=T.useState([]),r=T.useRef([]),l=T.useRef(null),s=T.useCallback(()=>{const m=speechSynthesis.getVoices().filter(u=>u.lang.startsWith("it"));return m.find(u=>u.name.includes("Emma"))||m.find(u=>u.name.includes("Enhanced")||u.name.includes("Premium"))||m[0]||null},[]),d=T.useCallback(()=>{speechSynthesis.cancel(),r.current=[],t(!1),i(-1)},[]),y=T.useCallback((F,m=0)=>{speechSynthesis.cancel(),r.current=F.slice(m),a(F);const u=()=>{if(r.current.length===0){t(!1),i(-1);return}const f=r.current.shift(),S=F.indexOf(f);i(S);const k=`${f.title}. ${tg(f.text)}`,x=new SpeechSynthesisUtterance(k);x.lang="it-IT",x.rate=1;const P=s();P&&(x.voice=P),x.onend=u,x.onerror=u,l.current=x,speechSynthesis.speak(x)};t(!0),u()},[s]),v=T.useCallback(()=>{speechSynthesis.pause(),t(!1)},[]),h=T.useCallback(()=>{speechSynthesis.resume(),t(!0)},[]),b=T.useCallback(()=>{speechSynthesis.cancel()},[]),z=T.useCallback((F,m,u,f)=>{const S=[];F&&S.push({title:"Cross-Synthesis",text:F,type:"synthesis"});for(const k of u)m[k.id]&&!m[k.id].startsWith("Errore")&&S.push({title:k.name,text:m[k.id],type:"thinker"});if(f&&f.length>0){const k=f.map(x=>{var P;return`${x.name}: ${x.description}${(P=x.citedBy)!=null&&P.length?`. Citato da ${x.citedBy.join(", ")}`:""}`}).join(`.

`);S.push({title:"Progetti Emergenti",text:k,type:"projects"})}y(S)},[y]),C=T.useCallback((F,m)=>{y([{title:F,text:m,type:"single"}])},[y]);return T.useEffect(()=>()=>speechSynthesis.cancel(),[]),{isPlaying:e,currentChapter:n,chapters:o,playAll:z,playSingle:C,pause:v,resume:h,stop:d,skipForward:b}}const nr=Wn?`?theme=${Wn}`:"",ig=`
