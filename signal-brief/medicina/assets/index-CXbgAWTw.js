 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(z,R){var O=z.length;z.push(R);e:for(;0<O;){var Z=O-1>>>1,oe=z[Z];if(0<o(oe,R))z[Z]=R,z[O]=oe,O=Z;else break e}}function n(z){return z.length===0?null:z[0]}function r(z){if(z.length===0)return null;var R=z[0],O=z.pop();if(O!==R){z[0]=O;e:for(var Z=0,oe=z.length,Mt=oe>>>1;Z<Mt;){var je=2*(Z+1)-1,Jt=z[je],dt=je+1,Zt=z[dt];if(0>o(Jt,O))dt<oe&&0>o(Zt,Jt)?(z[Z]=Zt,z[dt]=O,Z=dt):(z[Z]=Jt,z[je]=O,Z=je);else if(dt<oe&&0>o(Zt,O))z[Z]=Zt,z[dt]=O,Z=dt;else break e}}return R}function o(z,R){var O=z.sortIndex-R.sortIndex;return O!==0?O:z.id-R.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var i=Date,s=i.now();e.unstable_now=function(){return i.now()-s}}var a=[],f=[],y=1,v=null,g=3,S=!1,N=!1,_=!1,F=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function m(z){for(var R=n(f);R!==null;){if(R.callback===null)r(f);else if(R.startTime<=z)r(f),R.sortIndex=R.expirationTime,t(a,R);else break;R=n(f)}}function x(z){if(_=!1,m(z),!N)if(n(a)!==null)N=!0,se(E);else{var R=n(f);R!==null&&hn(x,R.startTime-z)}}function E(z,R){N=!1,_&&(_=!1,p(I),I=-1),S=!0;var O=g;try{for(m(R),v=n(a);v!==null&&(!(v.expirationTime>R)||z&&!fe());){var Z=v.callback;if(typeof Z=="function"){v.callback=null,g=v.priorityLevel;var oe=Z(v.expirationTime<=R);R=e.unstable_now(),typeof oe=="function"?v.callback=oe:v===n(a)&&r(a),m(R)}else r(a);v=n(a)}if(v!==null)var Mt=!0;else{var je=n(f);je!==null&&hn(x,je.startTime-R),Mt=!1}return Mt}finally{v=null,g=O,S=!1}}var w=!1,M=null,I=-1,J=5,D=-1;function fe(){return!(e.unstable_now()-D<J)}function Me(){if(M!==null){var z=e.unstable_now();D=z;var R=!0;try{R=M(!0,z)}finally{R?qt():(w=!1,M=null)}}else w=!1}var qt;if(typeof c=="function")qt=function(){c(Me)};else if(typeof MessageChannel<"u"){var Kn=new MessageChannel,hl=Kn.port2;Kn.port1.onmessage=Me,qt=function(){hl.postMessage(null)}}else qt=function(){F(Me,0)};function se(z){M=z,w||(w=!0,qt())}function hn(z,R){I=F(function(){z(e.unstable_now())},R)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(z){z.callback=null},e.unstable_continueExecution=function(){N||S||(N=!0,se(E))},e.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):J=0<z?Math.floor(1e3/z):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return n(a)},e.unstable_next=function(z){switch(g){case 1:case 2:case 3:var R=3;break;default:R=g}var O=g;g=R;try{return z()}finally{g=O}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(z,R){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var O=g;g=z;try{return R()}finally{g=O}},e.unstable_scheduleCallback=function(z,R,O){var Z=e.unstable_now();switch(typeof O=="object"&&O!==null?(O=O.delay,O=typeof O=="number"&&0<O?Z+O:Z):O=Z,z){case 1:var oe=-1;break;case 2:oe=250;break;case 5:oe=1073741823;break;case 4:oe=1e4;break;default:oe=5e3}return oe=O+oe,z={id:y++,callback:R,priorityLevel:z,startTime:O,expirationTime:oe,sortIndex:-1},O>Z?(z.sortIndex=O,t(f,z),n(a)===null&&z===n(f)&&(_?(p(I),I=-1):_=!0,hn(x,O-Z))):(z.sortIndex=oe,t(a,z),N||S||(N=!0,se(E))),z},e.unstable_shouldYield=fe,e.unstable_wrapCallback=function(z){var R=g;return function(){var O=g;g=R;try{return z.apply(this,arguments)}finally{g=O}}}})(Iu);bu.exports=Iu;var Ef=bu.exports;/**
 * @license React
