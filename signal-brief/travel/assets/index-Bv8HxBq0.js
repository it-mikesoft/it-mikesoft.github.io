 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(z,O){var b=z.length;z.push(O);e:for(;0<b;){var Z=b-1>>>1,le=z[Z];if(0<l(le,O))z[Z]=O,z[b]=le,b=Z;else break e}}function n(z){return z.length===0?null:z[0]}function r(z){if(z.length===0)return null;var O=z[0],b=z.pop();if(b!==O){z[0]=b;e:for(var Z=0,le=z.length,_t=le>>>1;Z<_t;){var je=2*(Z+1)-1,Jt=z[je],ct=je+1,qt=z[ct];if(0>l(Jt,b))ct<le&&0>l(qt,Jt)?(z[Z]=qt,z[ct]=b,Z=ct):(z[Z]=Jt,z[je]=b,Z=je);else if(ct<le&&0>l(qt,b))z[Z]=qt,z[ct]=b,Z=ct;else break e}}return O}function l(z,O){var b=z.sortIndex-O.sortIndex;return b!==0?b:z.id-O.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var i=Date,s=i.now();e.unstable_now=function(){return i.now()-s}}var a=[],f=[],v=1,y=null,g=3,S=!1,N=!1,P=!1,$=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function m(z){for(var O=n(f);O!==null;){if(O.callback===null)r(f);else if(O.startTime<=z)r(f),O.sortIndex=O.expirationTime,t(a,O);else break;O=n(f)}}function x(z){if(P=!1,m(z),!N)if(n(a)!==null)N=!0,se(E);else{var O=n(f);O!==null&&hn(x,O.startTime-z)}}function E(z,O){N=!1,P&&(P=!1,p(L),L=-1),S=!0;var b=g;try{for(m(O),y=n(a);y!==null&&(!(y.expirationTime>O)||z&&!fe());){var Z=y.callback;if(typeof Z=="function"){y.callback=null,g=y.priorityLevel;var le=Z(y.expirationTime<=O);O=e.unstable_now(),typeof le=="function"?y.callback=le:y===n(a)&&r(a),m(O)}else r(a);y=n(a)}if(y!==null)var _t=!0;else{var je=n(f);je!==null&&hn(x,je.startTime-O),_t=!1}return _t}finally{y=null,g=b,S=!1}}var w=!1,_=null,L=-1,q=5,D=-1;function fe(){return!(e.unstable_now()-D<q)}function _e(){if(_!==null){var z=e.unstable_now();D=z;var O=!0;try{O=_(!0,z)}finally{O?Xt():(w=!1,_=null)}}else w=!1}var Xt;if(typeof c=="function")Xt=function(){c(_e)};else if(typeof MessageChannel<"u"){var Kn=new MessageChannel,ho=Kn.port2;Kn.port1.onmessage=_e,Xt=function(){ho.postMessage(null)}}else Xt=function(){$(_e,0)};function se(z){_=z,w||(w=!0,Xt())}function hn(z,O){L=$(function(){z(e.unstable_now())},O)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(z){z.callback=null},e.unstable_continueExecution=function(){N||S||(N=!0,se(E))},e.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):q=0<z?Math.floor(1e3/z):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return n(a)},e.unstable_next=function(z){switch(g){case 1:case 2:case 3:var O=3;break;default:O=g}var b=g;g=O;try{return z()}finally{g=b}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(z,O){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var b=g;g=z;try{return O()}finally{g=b}},e.unstable_scheduleCallback=function(z,O,b){var Z=e.unstable_now();switch(typeof b=="object"&&b!==null?(b=b.delay,b=typeof b=="number"&&0<b?Z+b:Z):b=Z,z){case 1:var le=-1;break;case 2:le=250;break;case 5:le=1073741823;break;case 4:le=1e4;break;default:le=5e3}return le=b+le,z={id:v++,callback:O,priorityLevel:z,startTime:b,expirationTime:le,sortIndex:-1},b>Z?(z.sortIndex=b,t(f,z),n(a)===null&&z===n(f)&&(P?(p(L),L=-1):P=!0,hn(x,b-Z))):(z.sortIndex=le,t(a,z),N||S||(N=!0,se(E))),z},e.unstable_shouldYield=fe,e.unstable_wrapCallback=function(z){var O=g;return function(){var b=g;g=O;try{return z.apply(this,arguments)}finally{g=b}}}})(Lu);Iu.exports=Lu;var Cf=Iu.exports;/**
 * @license React
