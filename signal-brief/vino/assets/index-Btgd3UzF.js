 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(T,L){var _=T.length;T.push(L);e:for(;0<_;){var ee=_-1>>>1,ae=T[ee];if(0<o(ae,L))T[ee]=L,T[_]=ae,_=ee;else break e}}function n(T){return T.length===0?null:T[0]}function i(T){if(T.length===0)return null;var L=T[0],_=T.pop();if(_!==L){T[0]=_;e:for(var ee=0,ae=T.length,Pt=ae>>>1;ee<Pt;){var Ie=2*(ee+1)-1,Zt=T[Ie],dt=Ie+1,Xt=T[dt];if(0>o(Zt,_))dt<ae&&0>o(Xt,Zt)?(T[ee]=Xt,T[dt]=_,ee=dt):(T[ee]=Zt,T[Ie]=_,ee=Ie);else if(dt<ae&&0>o(Xt,_))T[ee]=Xt,T[dt]=_,ee=dt;else break e}}return L}function o(T,L){var _=T.sortIndex-L.sortIndex;return _!==0?_:T.id-L.id}if(typeof performance=="object"&&typeof performance.now=="function"){var a=performance;e.unstable_now=function(){return a.now()}}else{var r=Date,l=r.now();e.unstable_now=function(){return r.now()-l}}var s=[],p=[],y=1,v=null,h=3,b=!1,z=!1,C=!1,F=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,u=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function f(T){for(var L=n(p);L!==null;){if(L.callback===null)i(p);else if(L.startTime<=T)i(p),L.sortIndex=L.expirationTime,t(s,L);else break;L=n(p)}}function S(T){if(C=!1,f(T),!z)if(n(s)!==null)z=!0,se(k);else{var L=n(p);L!==null&&yn(S,L.startTime-T)}}function k(T,L){z=!1,C&&(C=!1,m(O),O=-1),b=!0;var _=h;try{for(f(L),v=n(s);v!==null&&(!(v.expirationTime>L)||T&&!pe());){var ee=v.callback;if(typeof ee=="function"){v.callback=null,h=v.priorityLevel;var ae=ee(v.expirationTime<=L);L=e.unstable_now(),typeof ae=="function"?v.callback=ae:v===n(s)&&i(s),f(L)}else i(s);v=n(s)}if(v!==null)var Pt=!0;else{var Ie=n(p);Ie!==null&&yn(S,Ie.startTime-L),Pt=!1}return Pt}finally{v=null,h=_,b=!1}}var x=!1,P=null,O=-1,X=5,j=-1;function pe(){return!(e.unstable_now()-j<X)}function Pe(){if(P!==null){var T=e.unstable_now();j=T;var L=!0;try{L=P(!0,T)}finally{L?Jt():(x=!1,P=null)}}else x=!1}var Jt;if(typeof u=="function")Jt=function(){u(Pe)};else if(typeof MessageChannel<"u"){var Xn=new MessageChannel,Ea=Xn.port2;Xn.port1.onmessage=Pe,Jt=function(){Ea.postMessage(null)}}else Jt=function(){F(Pe,0)};function se(T){P=T,x||(x=!0,Jt())}function yn(T,L){O=F(function(){T(e.unstable_now())},L)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(T){T.callback=null},e.unstable_continueExecution=function(){z||b||(z=!0,se(k))},e.unstable_forceFrameRate=function(T){0>T||125<T?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):X=0<T?Math.floor(1e3/T):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(T){switch(h){case 1:case 2:case 3:var L=3;break;default:L=h}var _=h;h=L;try{return T()}finally{h=_}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(T,L){switch(T){case 1:case 2:case 3:case 4:case 5:break;default:T=3}var _=h;h=T;try{return L()}finally{h=_}},e.unstable_scheduleCallback=function(T,L,_){var ee=e.unstable_now();switch(typeof _=="object"&&_!==null?(_=_.delay,_=typeof _=="number"&&0<_?ee+_:ee):_=ee,T){case 1:var ae=-1;break;case 2:ae=250;break;case 5:ae=1073741823;break;case 4:ae=1e4;break;default:ae=5e3}return ae=_+ae,T={id:y++,callback:L,priorityLevel:T,startTime:_,expirationTime:ae,sortIndex:-1},_>ee?(T.sortIndex=_,t(p,T),n(s)===null&&T===n(p)&&(C?(m(O),O=-1):C=!0,yn(S,_-ee))):(T.sortIndex=ae,t(s,T),z||b||(z=!0,se(k))),T},e.unstable_shouldYield=pe,e.unstable_wrapCallback=function(T){var L=h;return function(){var _=h;h=L;try{return T.apply(this,arguments)}finally{h=_}}}})(Hc);Bc.exports=Hc;var Dp=Bc.exports;/**
 * @license React
...
`);S.push({title:"Progetti Emergenti",text:k,type:"projects"})}y(S)},[y]),C=w.useCallback((F,m)=>{y([{title:F,text:m,type:"single"}])},[y]);return w.useEffect(()=>()=>speechSynthesis.cancel(),[]),{isPlaying:e,currentChapter:n,chapters:o,playAll:z,playSingle:C,pause:v,resume:h,stop:p,skipForward:b}}const rr=Kn?`?theme=${Kn}`:"",cg=`
