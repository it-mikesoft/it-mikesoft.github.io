...
`);S.push({title:"Progetti Emergenti",text:w,type:"projects"})}y(S)},[y]),C=T.useCallback((F,m)=>{y([{title:F,text:m,type:"single"}])},[y]);return T.useEffect(()=>()=>speechSynthesis.cancel(),[]),{isPlaying:e,currentChapter:n,chapters:o,playAll:z,playSingle:C,pause:v,resume:h,stop:d,skipForward:b}}const nr=Wn?`?theme=${Wn}`:"",ag=`
