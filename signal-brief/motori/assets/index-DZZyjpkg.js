...
`);S.push({title:"Progetti Emergenti",text:z,type:"projects"})}y(S)},[y]),C=T.useCallback((F,m)=>{y([{title:F,text:m,type:"single"}])},[y]);return T.useEffect(()=>()=>speechSynthesis.cancel(),[]),{isPlaying:e,currentChapter:n,chapters:o,playAll:I,playSingle:C,pause:v,resume:h,stop:d,skipForward:b}}const nr=Wn?`?theme=${Wn}`:"",ag=`
