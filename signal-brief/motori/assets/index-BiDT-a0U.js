 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var kp=T,Cp=Symbol.for("react.element"),Tp=Symbol.for("react.fragment"),Pp=Object.prototype.hasOwnProperty,Ap=kp.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Mp={key:!0,ref:!0,__self:!0,__source:!0};function jc(e,t,n){var i,o={},a=null,r=null;n!==void 0&&(a=""+n),t.key!==void 0&&(a=""+t.key),t.ref!==void 0&&(r=t.ref);for(i in t)Pp.call(t,i)&&!Mp.hasOwnProperty(i)&&(o[i]=t[i]);if(e&&e.defaultProps)for(i in t=e.defaultProps,t)o[i]===void 0&&(o[i]=t[i]);return{$$typeof:Cp,type:e,key:a,ref:r,props:o,_owner:Ap.current}}Zo.Fragment=Tp;Zo.jsx=jc;Zo.jsxs=jc;wc.exports=Zo;var c=wc.exports,Lc={exports:{}},Ke={},_c={exports:{}},Dc={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(k,L){var _=k.length;k.push(L);e:for(;0<_;){var ee=_-1>>>1,ae=k[ee];if(0<o(ae,L))k[ee]=L,k[_]=ae,_=ee;else break e}}function n(k){return k.length===0?null:k[0]}function i(k){if(k.length===0)return null;var L=k[0],_=k.pop();if(_!==L){k[0]=_;e:for(var ee=0,ae=k.length,Tt=ae>>>1;ee<Tt;){var we=2*(ee+1)-1,Jt=k[we],dt=we+1,Zt=k[dt];if(0>o(Jt,_))dt<ae&&0>o(Zt,Jt)?(k[ee]=Zt,k[dt]=_,ee=dt):(k[ee]=Jt,k[we]=_,ee=we);else if(dt<ae&&0>o(Zt,_))k[ee]=Zt,k[dt]=_,ee=dt;else break e}}return L}function o(k,L){var _=k.sortIndex-L.sortIndex;return _!==0?_:k.id-L.id}if(typeof performance=="object"&&typeof performance.now=="function"){var a=performance;e.unstable_now=function(){return a.now()}}else{var r=Date,l=r.now();e.unstable_now=function(){return r.now()-l}}var s=[],d=[],y=1,v=null,h=3,b=!1,I=!1,C=!1,F=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,u=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function f(k){for(var L=n(d);L!==null;){if(L.callback===null)i(d);else if(L.startTime<=k)i(d),L.sortIndex=L.expirationTime,t(s,L);else break;L=n(d)}}function S(k){if(C=!1,f(k),!I)if(n(s)!==null)I=!0,se(z);else{var L=n(d);L!==null&&yn(S,L.startTime-k)}}function z(k,L){I=!1,C&&(C=!1,m(O),O=-1),b=!0;var _=h;try{for(f(L),v=n(s);v!==null&&(!(v.expirationTime>L)||k&&!pe());){var ee=v.callback;if(typeof ee=="function"){v.callback=null,h=v.priorityLevel;var ae=ee(v.expirationTime<=L);L=e.unstable_now(),typeof ae=="function"?v.callback=ae:v===n(s)&&i(s),f(L)}else i(s);v=n(s)}if(v!==null)var Tt=!0;else{var we=n(d);we!==null&&yn(S,we.startTime-L),Tt=!1}return Tt}finally{v=null,h=_,b=!1}}var x=!1,P=null,O=-1,X=5,j=-1;function pe(){return!(e.unstable_now()-j<X)}function Pe(){if(P!==null){var k=e.unstable_now();j=k;var L=!0;try{L=P(!0,k)}finally{L?Yt():(x=!1,P=null)}}else x=!1}var Yt;if(typeof u=="function")Yt=function(){u(Pe)};else if(typeof MessageChannel<"u"){var Jn=new MessageChannel,va=Jn.port2;Jn.port1.onmessage=Pe,Yt=function(){va.postMessage(null)}}else Yt=function(){F(Pe,0)};function se(k){P=k,x||(x=!0,Yt())}function yn(k,L){O=F(function(){k(e.unstable_now())},L)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(k){k.callback=null},e.unstable_continueExecution=function(){I||b||(I=!0,se(z))},e.unstable_forceFrameRate=function(k){0>k||125<k?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):X=0<k?Math.floor(1e3/k):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(k){switch(h){case 1:case 2:case 3:var L=3;break;default:L=h}var _=h;h=L;try{return k()}finally{h=_}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(k,L){switch(k){case 1:case 2:case 3:case 4:case 5:break;default:k=3}var _=h;h=k;try{return L()}finally{h=_}},e.unstable_scheduleCallback=function(k,L,_){var ee=e.unstable_now();switch(typeof _=="object"&&_!==null?(_=_.delay,_=typeof _=="number"&&0<_?ee+_:ee):_=ee,k){case 1:var ae=-1;break;case 2:ae=250;break;case 5:ae=1073741823;break;case 4:ae=1e4;break;default:ae=5e3}return ae=_+ae,k={id:y++,callback:L,priorityLevel:k,startTime:_,expirationTime:ae,sortIndex:-1},_>ee?(k.sortIndex=_,t(d,k),n(s)===null&&k===n(d)&&(C?(m(O),O=-1):C=!0,yn(S,_-ee))):(k.sortIndex=ae,t(s,k),I||b||(I=!0,se(z))),k},e.unstable_shouldYield=pe,e.unstable_wrapCallback=function(k){var L=h;return function(){var _=h;h=L;try{return k.apply(this,arguments)}finally{h=_}}}})(Dc);_c.exports=Dc;var Op=_c.exports;/**
 * @license React
...
`).trim():""}function ng(){const[e,t]=T.useState(!1),[n,i]=T.useState(-1),[o,a]=T.useState([]),r=T.useRef([]),l=T.useRef(null),s=T.useCallback(()=>{const m=speechSynthesis.getVoices().filter(u=>u.lang.startsWith("it"));return m.find(u=>u.name.includes("Emma"))||m.find(u=>u.name.includes("Enhanced")||u.name.includes("Premium"))||m[0]||null},[]),d=T.useCallback(()=>{speechSynthesis.cancel(),r.current=[],t(!1),i(-1)},[]),y=T.useCallback((F,m=0)=>{speechSynthesis.cancel(),r.current=F.slice(m),a(F);const u=()=>{if(r.current.length===0){t(!1),i(-1);return}const f=r.current.shift(),S=F.indexOf(f);i(S);const z=`${f.title}. ${tg(f.text)}`,x=new SpeechSynthesisUtterance(z);x.lang="it-IT",x.rate=1;const P=s();P&&(x.voice=P),x.onend=u,x.onerror=u,l.current=x,speechSynthesis.speak(x)};t(!0),u()},[s]),v=T.useCallback(()=>{speechSynthesis.pause(),t(!1)},[]),h=T.useCallback(()=>{speechSynthesis.resume(),t(!0)},[]),b=T.useCallback(()=>{speechSynthesis.cancel()},[]),I=T.useCallback((F,m,u,f)=>{const S=[];F&&S.push({title:"Cross-Synthesis",text:F,type:"synthesis"});for(const z of u)m[z.id]&&!m[z.id].startsWith("Errore")&&S.push({title:z.name,text:m[z.id],type:"thinker"});if(f&&f.length>0){const z=f.map(x=>{var P;return`${x.name}: ${x.description}${(P=x.citedBy)!=null&&P.length?`. Citato da ${x.citedBy.join(", ")}`:""}`}).join(`.

`);S.push({title:"Progetti Emergenti",text:z,type:"projects"})}y(S)},[y]),C=T.useCallback((F,m)=>{y([{title:F,text:m,type:"single"}])},[y]);return T.useEffect(()=>()=>speechSynthesis.cancel(),[]),{isPlaying:e,currentChapter:n,chapters:o,playAll:I,playSingle:C,pause:v,resume:h,stop:d,skipForward:b}}const nr=Wn?`?theme=${Wn}`:"",ig=`
