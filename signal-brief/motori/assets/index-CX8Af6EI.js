 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var Mp=z,Op=Symbol.for("react.element"),Rp=Symbol.for("react.fragment"),jp=Object.prototype.hasOwnProperty,Lp=Mp.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,_p={key:!0,ref:!0,__self:!0,__source:!0};function Fc(e,t,n){var i,o={},a=null,r=null;n!==void 0&&(a=""+n),t.key!==void 0&&(a=""+t.key),t.ref!==void 0&&(r=t.ref);for(i in t)jp.call(t,i)&&!_p.hasOwnProperty(i)&&(o[i]=t[i]);if(e&&e.defaultProps)for(i in t=e.defaultProps,t)o[i]===void 0&&(o[i]=t[i]);return{$$typeof:Op,type:e,key:a,ref:r,props:o,_owner:Lp.current}}na.Fragment=Rp;na.jsx=Fc;na.jsxs=Fc;Tc.exports=na;var c=Tc.exports,Uc={exports:{}},Ke={},Bc={exports:{}},Hc={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(C,L){var _=C.length;C.push(L);e:for(;0<_;){var ee=_-1>>>1,ae=C[ee];if(0<o(ae,L))C[ee]=L,C[_]=ae,_=ee;else break e}}function n(C){return C.length===0?null:C[0]}function i(C){if(C.length===0)return null;var L=C[0],_=C.pop();if(_!==L){C[0]=_;e:for(var ee=0,ae=C.length,Pt=ae>>>1;ee<Pt;){var ke=2*(ee+1)-1,Zt=C[ke],dt=ke+1,Xt=C[dt];if(0>o(Zt,_))dt<ae&&0>o(Xt,Zt)?(C[ee]=Xt,C[dt]=_,ee=dt):(C[ee]=Zt,C[ke]=_,ee=ke);else if(dt<ae&&0>o(Xt,_))C[ee]=Xt,C[dt]=_,ee=dt;else break e}}return L}function o(C,L){var _=C.sortIndex-L.sortIndex;return _!==0?_:C.id-L.id}if(typeof performance=="object"&&typeof performance.now=="function"){var a=performance;e.unstable_now=function(){return a.now()}}else{var r=Date,l=r.now();e.unstable_now=function(){return r.now()-l}}var s=[],p=[],y=1,v=null,h=3,b=!1,I=!1,T=!1,F=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,u=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function f(C){for(var L=n(p);L!==null;){if(L.callback===null)i(p);else if(L.startTime<=C)i(p),L.sortIndex=L.expirationTime,t(s,L);else break;L=n(p)}}function S(C){if(T=!1,f(C),!I)if(n(s)!==null)I=!0,se(w);else{var L=n(p);L!==null&&yn(S,L.startTime-C)}}function w(C,L){I=!1,T&&(T=!1,m(O),O=-1),b=!0;var _=h;try{for(f(L),v=n(s);v!==null&&(!(v.expirationTime>L)||C&&!pe());){var ee=v.callback;if(typeof ee=="function"){v.callback=null,h=v.priorityLevel;var ae=ee(v.expirationTime<=L);L=e.unstable_now(),typeof ae=="function"?v.callback=ae:v===n(s)&&i(s),f(L)}else i(s);v=n(s)}if(v!==null)var Pt=!0;else{var ke=n(p);ke!==null&&yn(S,ke.startTime-L),Pt=!1}return Pt}finally{v=null,h=_,b=!1}}var x=!1,P=null,O=-1,X=5,j=-1;function pe(){return!(e.unstable_now()-j<X)}function Pe(){if(P!==null){var C=e.unstable_now();j=C;var L=!0;try{L=P(!0,C)}finally{L?Jt():(x=!1,P=null)}}else x=!1}var Jt;if(typeof u=="function")Jt=function(){u(Pe)};else if(typeof MessageChannel<"u"){var Xn=new MessageChannel,Ea=Xn.port2;Xn.port1.onmessage=Pe,Jt=function(){Ea.postMessage(null)}}else Jt=function(){F(Pe,0)};function se(C){P=C,x||(x=!0,Jt())}function yn(C,L){O=F(function(){C(e.unstable_now())},L)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(C){C.callback=null},e.unstable_continueExecution=function(){I||b||(I=!0,se(w))},e.unstable_forceFrameRate=function(C){0>C||125<C?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):X=0<C?Math.floor(1e3/C):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(C){switch(h){case 1:case 2:case 3:var L=3;break;default:L=h}var _=h;h=L;try{return C()}finally{h=_}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(C,L){switch(C){case 1:case 2:case 3:case 4:case 5:break;default:C=3}var _=h;h=C;try{return L()}finally{h=_}},e.unstable_scheduleCallback=function(C,L,_){var ee=e.unstable_now();switch(typeof _=="object"&&_!==null?(_=_.delay,_=typeof _=="number"&&0<_?ee+_:ee):_=ee,C){case 1:var ae=-1;break;case 2:ae=250;break;case 5:ae=1073741823;break;case 4:ae=1e4;break;default:ae=5e3}return ae=_+ae,C={id:y++,callback:L,priorityLevel:C,startTime:_,expirationTime:ae,sortIndex:-1},_>ee?(C.sortIndex=_,t(p,C),n(s)===null&&C===n(p)&&(T?(m(O),O=-1):T=!0,yn(S,_-ee))):(C.sortIndex=ae,t(s,C),I||b||(I=!0,se(w))),C},e.unstable_shouldYield=pe,e.unstable_wrapCallback=function(C){var L=h;return function(){var _=h;h=L;try{return C.apply(this,arguments)}finally{h=_}}}})(Hc);Bc.exports=Hc;var Dp=Bc.exports;/**
 * @license React
...
`),o=n&&n.length>0?n.join(", "):"GitHub Trending, trendshift.io, Hacker News",a=Sa(ya.projects,{signals:i,synthesis:t,sources_list:o}),s=((await xa(a)).text||"").trim().match(/\[[\s\S]*\]/);if(!s)throw new Error("Formato risposta non valido");return JSON.parse(s[0])}async function tg(e,t){const n=Sa(ya.conceptDiff,{old_synthesis:e,new_synthesis:t}),a=((await xa(n)).text||"").trim().match(/\{[\s\S]*\}/);if(!a)throw new Error("Formato risposta non valido");return JSON.parse(a[0])}const Ic="https://summon-star.casamon.dev";function Vd(e,t={}){return fetch(`${Jf}${e}`,{credentials:"include",...t})}async function ng(e){if(!e)return[];try{const t=await Vd(`/profiles/${e}/personas`);if(!t.ok)return[];const n=await t.json();return Array.isArray(n)?n:[]}catch{return[]}}async function ig(e,t,n,i){const o=t?`Contesto (cross-synthesis attuale):
${t}
...
`);s=v.pop()||"";let h="";for(const b of v)if(b.startsWith("event: "))h=b.slice(7).trim();else if(b.startsWith("data: ")&&h){try{const I=JSON.parse(b.slice(6));n(h,I)}catch{}h=""}}}function cn(e){if(!e)return"";let t=e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");return t=t.replace(/^###\s+(.+)$/gm,"<strong>$1</strong>"),t=t.replace(/^- (.+)$/gm,"• $1"),t=t.replace(/\[([^\]]+)\]\((https?:\/\/[^)]+)\)/g,'<a href="$2" target="_blank" rel="noopener noreferrer">$1</a>'),t=t.replace(/\*\*([^*]+)\*\*/g,"<strong>$1</strong>"),t=t.replace(/\*([^*]+)\*/g,"<em>$1</em>"),t}function og(e){if(!e)return"";const t=/^(\*\*\d+\..+?\*\*|###?\s+.+)$/gm,n=e.split(t);if(n.length<=1)return cn(e);let i="";for(let o=0;o<n.length;o++){const a=n[o].trim();if(a)if(t.test(a)){t.lastIndex=0;const r=a.replace(/^\*\*|\*\*$/g,"").replace(/^###?\s*/,"").trim(),l=o+1<n.length?n[o+1].trim():"";l?(i+=`<details open><summary>${kc(r)}</summary>${cn(l)}</details>`,o++):i+=`<strong>${kc(r)}</strong>`}else i+=cn(a)}return i}function kc(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ag(e,t){if(!e||!t||t.length===0)return e||"";const n=[...t].sort((i,o)=>o.name.length-i.name.length);for(const i of n){const o=i.name.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),a=new RegExp(`(?!<a[^>]*>)(${o})(?![^<]*<\\/a>)`,"g");e=e.replace(a,`<a href="#thinker-${i.id}" class="thinker-link">$1</a>`)}return e}const wc="​‌",zc="‌​";function rg(e,t){if(!e&&!t)return[];if(!e)return[{type:"added",text:t}];if(!t)return[{type:"removed",text:e}];const n=e.split(/(\s+)/),i=t.split(/(\s+)/),o=n.length,a=i.length,r=Array.from({length:o+1},()=>new Uint16Array(a+1));for(let v=1;v<=o;v++)for(let h=1;h<=a;h++)r[v][h]=n[v-1]===i[h-1]?r[v-1][h-1]+1:Math.max(r[v-1][h],r[v][h-1]);const l=[];let s=o,p=a;for(;s>0||p>0;)s>0&&p>0&&n[s-1]===i[p-1]?(l.unshift({type:"equal",text:n[s-1]}),s--,p--):p>0&&(s===0||r[s][p-1]>=r[s-1][p])?(l.unshift({type:"added",text:i[p-1]}),p--):(l.unshift({type:"removed",text:n[s-1]}),s--);const y=[];for(const v of l)y.length>0&&y[y.length-1].type===v.type?y[y.length-1].text+=v.text:y.push({...v});return y}function Cc(e,t){const n=t==="left"?"added":"removed",i=t==="left"?"removed":"added";let o="";for(const l of e)l.type!==n&&(l.type===i?o+=wc+l.text+zc:o+=l.text);let a=cn(o);const r=t==="left"?"diff-word-removed":"diff-word-added";return a=a.replace(new RegExp(`${wc}(.*?)${zc}`,"gs"),`<span class="${r}">$1</span>`),a}function lg(e){return e?e.replace(/^###\s+/gm,"").replace(/\*\*([^*]+)\*\*/g,"$1").replace(/\*([^*]+)\*/g,"$1").replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/^- /gm,"").replace(/^---+$/gm,"").replace(/^##\s+/gm,"").replace(/\n{3,}/g,`

`).trim():""}function sg(){const[e,t]=z.useState(!1),[n,i]=z.useState(-1),[o,a]=z.useState([]),r=z.useRef([]),l=z.useRef(null),s=z.useCallback(()=>{const m=speechSynthesis.getVoices().filter(u=>u.lang.startsWith("it"));return m.find(u=>u.name.includes("Emma"))||m.find(u=>u.name.includes("Enhanced")||u.name.includes("Premium"))||m[0]||null},[]),p=z.useCallback(()=>{speechSynthesis.cancel(),r.current=[],t(!1),i(-1)},[]),y=z.useCallback((F,m=0)=>{speechSynthesis.cancel(),r.current=F.slice(m),a(F);const u=()=>{if(r.current.length===0){t(!1),i(-1);return}const f=r.current.shift(),S=F.indexOf(f);i(S);const w=`${f.title}. ${lg(f.text)}`,x=new SpeechSynthesisUtterance(w);x.lang="it-IT",x.rate=1;const P=s();P&&(x.voice=P),x.onend=u,x.onerror=u,l.current=x,speechSynthesis.speak(x)};t(!0),u()},[s]),v=z.useCallback(()=>{speechSynthesis.pause(),t(!1)},[]),h=z.useCallback(()=>{speechSynthesis.resume(),t(!0)},[]),b=z.useCallback(()=>{speechSynthesis.cancel()},[]),I=z.useCallback((F,m,u,f)=>{const S=[];F&&S.push({title:"Cross-Synthesis",text:F,type:"synthesis"});for(const w of u)m[w.id]&&!m[w.id].startsWith("Errore")&&S.push({title:w.name,text:m[w.id],type:"thinker"});if(f&&f.length>0){const w=f.map(x=>{var P;return`${x.name}: ${x.description}${(P=x.citedBy)!=null&&P.length?`. Citato da ${x.citedBy.join(", ")}`:""}`}).join(`.

`);S.push({title:"Progetti Emergenti",text:w,type:"projects"})}y(S)},[y]),T=z.useCallback((F,m)=>{y([{title:F,text:m,type:"single"}])},[y]);return z.useEffect(()=>()=>speechSynthesis.cancel(),[]),{isPlaying:e,currentChapter:n,chapters:o,playAll:I,playSingle:T,pause:v,resume:h,stop:p,skipForward:b}}const rr=Kn?`?theme=${Kn}`:"",cg=`
...
`;function pg(){const[e,t]=z.useState(Wf),[n,i]=z.useState({}),[o,a]=z.useState({}),[r,l]=z.useState({}),[s,p]=z.useState(null),[y,v]=z.useState("idle"),[h,b]=z.useState(!1),[I,T]=z.useState(""),[F,m]=z.useState(""),[u,f]=z.useState(null),[S,w]=z.useState(!1),[x,P]=z.useState([]),[O,X]=z.useState(null),[j,pe]=z.useState("signals"),[Pe,Jt]=z.useState({leftIdx:1,rightIdx:0}),[Xn,Ea]=z.useState("emerging"),[se,yn]=z.useState([]),[C,L]=z.useState([]),[_,ee]=z.useState(null),[ae,Pt]=z.useState("idle"),[ke,Zt]=z.useState(Qf),[dt,Xt]=z.useState(""),[$d,Na]=z.useState(!1),[Wi,qd]=z.useState(!1),[Sn,Gd]=z.useState(""),[ei,Wl]=z.useState([]),[vt,xn]=z.useState("idle"),[Wd,Ql]=z.useState(!1),[Qi,ba]=z.useState(null),[Kl,Yl]=z.useState(null),[Ki,Qd]=z.useState([]),[Jl,En]=z.useState(null),[mg,fg]=z.useState("idle"),[Zl,Kd]=z.useState({scan:"",launchd:""}),[Yi,Ia]=z.useState("idle"),[gg,Xl]=z.useState([]),[Yd,Jd]=z.useState({}),[Zd,Xd]=z.useState(new Set),ka=z.useRef(null),he=sg(),[ep,tp]=z.useState(()=>new Date().toLocaleString("it-IT",{dateStyle:"short",timeStyle:"short"})),xe=e.filter(d=>d.active),es=xe.filter(d=>!d.fontiOnly),Nn=Object.values(r).filter(d=>d==="done"||d==="stale").length,wa=xe.length;z.useEffect(()=>{(async()=>{try{const d=await window.storage.get("signal-state");if(d){const g=JSON.parse(d.value);if(g.results){i(g.results);const N=new Set((g.staleIds||[]).map(String)),A={};for(const H of Object.keys(g.results))g.results[H].startsWith("Errore")?A[H]="error":N.has(String(H))?A[H]="stale":A[H]="done";l(A),g.staleIds&&Xl(g.staleIds)}if(g.prevResults&&a(g.prevResults),g.lastScanTime&&f(g.lastScanTime),g.synthesis&&(p(g.synthesis),v("done")),g.synthesisHistory){const N=g.synthesisHistory.map((A,H,G)=>{if(A.conceptDiff&&!A.conceptDiffs){const Ee=G[H+1],{conceptDiff:_e,...Je}=A;return Ee?{...Je,conceptDiffs:{[Ee.id]:_e}}:Je}return A});P(N)}g.projects&&yn(g.projects),g.prevProjects&&L(g.prevProjects),g.projectsTime&&ee(g.projectsTime),g.projectSources&&Zt(g.projectSources)}}catch{}})()},[]);const Ae=z.useCallback(async(d={})=>{try{const g=await window.storage.get("signal-state"),A={...g?JSON.parse(g.value):{},...d};await window.storage.set("signal-state",JSON.stringify(A))}catch{}},[]);z.useCallback(async(d={})=>{await Ae({results:n,prevResults:o,lastScanTime:u,synthesis:s,synthesisHistory:x,projects:se,prevProjects:C,projectsTime:_,projectSources:ke,...d})},[n,o,u,s,x,se,C,_,ke,Ae]);const Ji=z.useCallback((d,g)=>g.length>0&&g[0].text===d?g:[{id:`synth_${Date.now()}`,timestamp:Date.now(),text:d,thinkers:xe.map(A=>A.name),conceptDiffs:{}},...g].slice(0,50),[xe]),Zi=z.useCallback(async d=>{var A;if(d.length<2)return d;const g=d[0],N=d[1];if((A=g.conceptDiffs)!=null&&A[N.id])return d;try{const H=await tg(N.text,g.text),G=[...d];return G[0]={...G[0],conceptDiffs:{...G[0].conceptDiffs||{},[N.id]:H}},P(G),await Ae({synthesisHistory:G}),G}catch(H){return console.error("[concept-diff auto]",H),d}},[Ae]),ts=z.useCallback(async(d,g)=>{try{await navigator.clipboard.writeText(d)}catch{const N=document.createElement("textarea");N.value=d,document.body.appendChild(N),N.select(),document.execCommand("copy"),document.body.removeChild(N)}X(g),setTimeout(()=>X(null),2e3)},[]);z.useCallback(async d=>{const g=x.filter(N=>N.id!==d);P(g),await Ae({synthesisHistory:g})},[x,Ae]);const za=z.useCallback(async()=>{Ia("loading");const d="/signal-brief/motori/";try{const[g,N]=await Promise.all([fetch(`${d}logs/auto-scan.log`,{cache:"no-cache"}),fetch(`${d}logs/launchd-out.log`,{cache:"no-cache"})]),A=g.ok?await g.text():"",H=N.ok?await N.text():"";Kd({scan:A,launchd:H}),Ia("done")}catch(g){console.error("[logs]",g),Ia("error")}},[]);z.useEffect(()=>{j==="log"&&za()},[j,za]);const ns=z.useCallback(d=>{if(!d)return;const g=d.trim().toLowerCase();if(!g)return;const N=e.find(A=>{const H=A.name.toLowerCase();return H===g||H.includes(g)||g.includes(H)});N&&(pe("signals"),w(!1),setTimeout(()=>{const A=document.getElementById(`thinker-${N.id}`);A&&(A.scrollIntoView({behavior:"smooth",block:"start"}),A.classList.add("thinker-card-highlight"),setTimeout(()=>A.classList.remove("thinker-card-highlight"),1800))},60))},[e]),np=(d,g)=>{if(!d||!g)return 0;const N=new Set(d.toLowerCase().split(/\s+/)),A=new Set(g.toLowerCase().split(/\s+/));return[...N].filter(G=>A.has(G)).length/Math.max(N.size,A.size)},is=d=>!o[d]||!n[d]?!1:np(o[d],n[d])<.72;xe.filter(d=>r[d.id]==="done"&&is(d.id)).length;const os=e.length>0&&e.every(d=>d.active),ip=()=>{h||t(d=>d.map(g=>({...g,active:!os})))},Ca=()=>{I.trim()&&(t(d=>[...d,{id:Date.now(),name:I.trim(),handle:F.trim()||"@?",domain:"Custom",active:!0}]),T(""),m(""))},as=()=>{const d=dt.trim();if(!d||ke.includes(d))return;const g=[...ke,d];Zt(g),Xt(""),Ae({projectSources:g})},op=d=>{const g=ke.filter(N=>N!==d);Zt(g),Ae({projectSources:g})},[ap,rs]=z.useState(null),Xi=z.useCallback(async(d,g)=>{Pt("loading"),rs(null);try{const N=await eg(g,d,ke);L(se),yn(N);const A=Date.now();ee(A),Pt("done"),await Ae({projects:N,prevProjects:se,projectsTime:A})}catch(N){console.error("[Signal.Brief] fetchProjects error:",N),Pt("error"),rs(N.message)}},[ke,Ae,se]),rp=z.useCallback(async()=>{if(xe.length===0)return;pe("signals"),b(!0),p(null),v("idle"),a(B=>({...B,...n}));const d={...n},g={};for(const B of xe){const ce=d[B.id];ce&&!ce.startsWith("Errore")&&(g[B.id]=ce)}const N={};xe.forEach(B=>{N[B.id]="loading"}),l(N),i(g);const A={...g},H=[],G={},Ee=2,_e=B=>new Promise(ce=>setTimeout(ce,B));for(let B=0;B<xe.length;B+=Ee){const ce=xe.slice(B,B+Ee);await Promise.all(ce.map(async Me=>{try{const V=await Xf(Me);A[Me.id]=V,i(re=>({...re,[Me.id]:V})),l(re=>({...re,[Me.id]:"done"}))}catch(V){const re=g[Me.id]!=null,me=V.message||V.name||(typeof V=="string"?V:"errore sconosciuto");G[Me.id]=me,re?(H.push(String(Me.id)),l(Y=>({...Y,[Me.id]:"stale"}))):(A[Me.id]=`Errore: ${me}`,i(Y=>({...Y,[Me.id]:`Errore: ${me}`})),l(Y=>({...Y,[Me.id]:"error"})))}})),B+Ee<xe.length&&await _e(1200)}Xl(H),Jd(G);const Je=Zf(A),$e=Je?Date.now():u;Je&&(f($e),tp(new Date().toLocaleString("it-IT",{dateStyle:"short",timeStyle:"short"}))),await Ae({results:A,prevResults:d,lastScanTime:$e,synthesis:s,synthesisHistory:x,staleIds:H}),b(!1);const De=es.filter(B=>A[B.id]&&!A[B.id].startsWith("Errore")).map(B=>({name:B.name,domain:B.domain,content:A[B.id]}));if(De.length>=2){v("loading");try{const B=await bc(De);p(B),v("done");const ce=Ji(B,x);P(ce),await Ae({results:A,prevResults:d,lastScanTime:$e,synthesis:B,synthesisHistory:ce}),Zi(ce),Xi(B,De)}catch{v("error")}}},[xe,n,Ae,s,x,Ji,u,Xi,Zi]),lp=z.useCallback(async()=>{const d=es.filter(g=>r[g.id]==="done"||r[g.id]==="stale").map(g=>({name:g.name,domain:g.domain,content:n[g.id]}));if(!(d.length<2)){v("loading");try{const g=await bc(d);p(g),v("done");const N=Ji(g,x);P(N),await Ae({synthesis:g,synthesisHistory:N}),Zi(N),Xi(g,d)}catch(g){p(`Errore nella sintesi: ${g.message}`),v("error")}}},[xe,r,n,Ae,x,Ji,Xi,Zi]),[ti,sp]=z.useState(nn.boardId),[ls,cp]=z.useState(nn.provisioned!==!1);z.useEffect(()=>{!Wi||!ti||ng(ti).then(d=>Qd(d))},[Wi,ti]);const ss=z.useCallback(async()=>{if(!Sn.trim())return;Wl([]),ba(null),Yl(null);let d=ti;if(!ls&&Kn){xn("provisioning");try{const g=await fetch(`/admin/api/themes/${Kn}/provision-council`,{method:"POST"}),N=await g.json();if(!g.ok||!N.ok)throw new Error(N.error||`HTTP ${g.status}`);d=N.boardId,sp(d),cp(!0)}catch(g){console.error("[council] provisioning failed",g),xn("error");return}}xn("loading"),Ql(!1),En(null);try{await ig(Sn,s,(g,N)=>{if(g==="session_started"&&N.session_id&&Yl(N.session_id),g==="sage_speaks"&&N.content&&(En(N.persona_name),Wl(A=>[...A,{name:N.persona_name,icon:N.persona_icon,color:N.persona_color,content:N.content,speaking:!1}])),g==="moderator_synthesis"&&N.content&&(En("moderatore"),ba(N.content)),g==="moderator"){const A=N.content||N.decision||N.synthesis||"";A&&ba(A)}g==="done"&&En(null)},d),En(null),xn("done")}catch(g){console.error("[council]",g),En(null),g.code==="AUTH_REQUIRED"?(Ql(!0),xn("idle")):xn("error")}},[Sn,s,ti,ls]),up=Nn>=2&&!h&&y!=="loading",cs=Object.keys(n).length>0,us="Disponibile solo in locale (richiede Claude CLI)",dp=xe.filter(d=>{if(!r[d.id])return!1;if(S){const g=r[d.id];return(g==="done"||g==="stale")&&is(d.id)}return!0});return c.jsxs(c.Fragment,{children:[c.jsx("style",{children:dg}),c.jsxs("div",{className:"dashboard",children:[c.jsx("div",{className:"scanline"}),c.jsxs("header",{className:"header",children:[c.jsxs("div",{className:"header-top",children:[c.jsxs("div",{className:"header-left",children:[c.jsx("div",{className:"logo",style:{cursor:"pointer"},onClick:()=>Na(!0),dangerouslySetInnerHTML:{__html:ve.nameHtml}}),c.jsx("div",{className:"tagline",children:ve.tagline})]}),c.jsxs("div",{className:"header-right",children:[u&&c.jsxs("span",{className:"timestamp",children:["ultimo: ",ep]}),c.jsx("button",{className:"btn btn-synthesis btn-small",onClick:lp,disabled:!up||!0,title:us,children:"◈ Synth"}),c.jsx("button",{className:"btn btn-ghost btn-small",onClick:()=>{if(!ka.current){const g=new Audio(`/signal-brief/motori/podcast/episodes/${new Date().toISOString().slice(0,10)}.mp3${rr}`);g.onerror=()=>{g.src=`/signal-brief/motori/podcast/episodes/2026-04-12.mp3${rr}`,g.play()},ka.current=g}const d=ka.current;d.paused?d.play():d.pause()},title:"Ascolta l'ultimo episodio",children:"🎙 Podcast"}),c.jsx("a",{className:"btn btn-ghost btn-small",href:`/signal-brief/motori/podcast/${rr}`,title:"Archivio puntate con testo, sintesi, comparazione e fonti",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:"☰ Archivio"}),c.jsx("button",{className:"btn btn-primary",onClick:()=>rp(),disabled:h||xe.length===0||!0,title:us,children:h?`Scanning ${Nn}/${wa}…`:"▶ Scan"})]})]}),c.jsxs("nav",{className:"tab-bar",children:[c.jsxs("button",{className:`tab-btn ${j==="signals"?"active":""}`,onClick:()=>pe("signals"),children:["Segnali",Nn>0&&c.jsx("span",{className:"tab-badge",children:Nn})]}),c.jsxs("button",{className:`tab-btn ${j==="projects"?"active":""}`,onClick:()=>pe("projects"),children:["Progetti",se.length>0&&c.jsx("span",{className:"tab-badge",children:se.length})]}),c.jsxs("button",{className:`tab-btn ${j==="history"?"active":""}`,onClick:()=>pe("history"),children:["Cronologia",x.length>0&&c.jsx("span",{className:"tab-badge",children:x.length})]}),c.jsx("button",{className:`tab-btn ${j==="log"?"active":""}`,onClick:()=>pe("log"),children:"▤ Log"}),c.jsx("button",{className:`tab-btn ${j==="config"?"active":""}`,onClick:()=>pe("config"),children:"⚙ Configurazione"})]})]}),c.jsxs("div",{className:"tab-content",children:[j==="signals"&&c.jsxs(c.Fragment,{children:[h&&c.jsx("div",{className:"progress-bar",children:c.jsx("div",{className:"progress-fill",style:{width:`${wa>0?Nn/wa*100:0}%`}})}),(s||y==="loading")&&c.jsxs("div",{className:"synthesis-panel",children:[c.jsxs("div",{className:"synthesis-header",children:[c.jsx("span",{className:"synthesis-label",children:"◈ Cross-Synthesis"}),c.jsx("span",{className:"synthesis-title",children:y==="loading"?"Elaborazione…":"Temi emergenti trasversali"}),y==="done"&&x.length>0&&c.jsx("span",{className:"timestamp",children:new Date(x[0].timestamp).toLocaleString("it-IT",{dateStyle:"short",timeStyle:"short"})}),y==="done"&&c.jsxs("div",{className:"synthesis-actions",children:[c.jsx("button",{className:"btn-listen",onClick:()=>he.playSingle("Cross-Synthesis",s),title:"Ascolta",children:"🔊"}),c.jsx("button",{className:"btn btn-ghost btn-small",onClick:()=>qd(d=>!d),title:"Chiedi ai thinkers",style:Wi?{background:"#ede9fe",color:"#7c3aed",borderColor:"#d8b4fe"}:{},children:"📡 Chiedi"}),c.jsx("button",{className:"btn btn-ghost btn-small",onClick:()=>ts(s,"synth"),children:O==="synth"?"Copiato ✓":"Copia ❐"})]})]}),y==="loading"?c.jsxs("div",{className:"card-loading-state",children:[c.jsx("div",{className:"spinner"}),"Analisi in corso…"]}):c.jsx("div",{className:"synthesis-body",dangerouslySetInnerHTML:{__html:ag(cn(s),xe)}}),Wi&&y==="done"&&c.jsxs("div",{className:"council-panel",children:[c.jsxs("div",{className:"council-header",children:[Kl?c.jsx("a",{className:"council-label",href:`${Ic}/?context=session:${Kl}`,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",cursor:"pointer"},children:"📡 Assemblea Signal-Brief ↗"}):c.jsx("span",{className:"council-label",children:"📡 Assemblea Signal-Brief"}),Ki.length>0&&c.jsxs("span",{style:{fontFamily:"IBM Plex Mono,monospace",fontSize:10,color:"var(--sb-text-muted)"},children:[Ki.filter(d=>!d.is_moderator).length," thinker · Summon Stars"]})]}),Ki.length>0&&c.jsx("div",{className:"council-composition",children:Ki.map(d=>c.jsxs("div",{className:`council-persona-chip${d.is_moderator?" is-moderator":""}`,title:d.title||"",children:[c.jsx("span",{className:"chip-icon",children:d.icon||"⭐"}),c.jsx("span",{className:"chip-name",style:d.is_moderator?{}:{color:d.color},children:d.name})]},d.id))}),Wd&&c.jsxs("div",{className:"council-auth-notice",children:["🔒 Accesso non autorizzato. Effettua il login su"," ",c.jsx("a",{href:Ic,target:"_blank",rel:"noopener noreferrer",children:"Summon Stars"})," ","e riprova."]}),c.jsxs("div",{className:"council-input-row",children:[c.jsx("input",{className:"council-input",placeholder:"Fai una domanda ai thinkers...",value:Sn,onChange:d=>Gd(d.target.value),onKeyDown:d=>d.key==="Enter"&&ss(),disabled:vt==="loading"||vt==="provisioning"}),c.jsx("button",{className:"btn btn-primary btn-small",onClick:ss,disabled:vt==="loading"||vt==="provisioning"||!Sn.trim(),children:vt==="provisioning"?"Creazione assemblea…":vt==="loading"?"In deliberazione…":"Chiedi"})]}),ei.length>0&&c.jsxs("div",{style:{maxHeight:420,overflowY:"auto"},children:[ei.map((d,g)=>{const A=g===ei.length-1&&vt==="loading"&&Jl===d.name;return c.jsxs("div",{className:`council-msg${A?" speaking":""}`,children:[c.jsxs("div",{className:"council-msg-name",style:{color:d.color},children:[d.icon," ",d.name,A&&c.jsx("span",{className:"council-msg-speaking-dot"})]}),c.jsx("div",{children:d.content})]},g)}),vt==="loading"&&Jl==="moderatore"&&c.jsx("div",{className:"council-msg speaking",children:c.jsxs("div",{className:"council-msg-name",style:{color:"#7c3aed"},children:["📡 Moderatore",c.jsx("span",{className:"council-msg-speaking-dot"})]})})]}),Qi&&c.jsxs("div",{className:"council-synthesis",children:[c.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between"},children:[c.jsx("div",{className:"council-synthesis-label",children:"Sintesi del moderatore"}),c.jsxs("div",{style:{display:"flex",gap:4},children:[c.jsx("button",{className:"btn-listen",onClick:()=>{const d=ei.map(g=>`${g.name}: ${g.content}`).join(`
