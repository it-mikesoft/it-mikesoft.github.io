 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var wp=T,Cp=Symbol.for("react.element"),Tp=Symbol.for("react.fragment"),Pp=Object.prototype.hasOwnProperty,Ap=wp.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Mp={key:!0,ref:!0,__self:!0,__source:!0};function Lc(e,t,n){var i,o={},a=null,r=null;n!==void 0&&(a=""+n),t.key!==void 0&&(a=""+t.key),t.ref!==void 0&&(r=t.ref);for(i in t)Pp.call(t,i)&&!Mp.hasOwnProperty(i)&&(o[i]=t[i]);if(e&&e.defaultProps)for(i in t=e.defaultProps,t)o[i]===void 0&&(o[i]=t[i]);return{$$typeof:Cp,type:e,key:a,ref:r,props:o,_owner:Ap.current}}Xo.Fragment=Tp;Xo.jsx=Lc;Xo.jsxs=Lc;zc.exports=Xo;var c=zc.exports,jc={exports:{}},Ke={},Dc={exports:{}},_c={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(w,j){var D=w.length;w.push(j);e:for(;0<D;){var ee=D-1>>>1,ae=w[ee];if(0<o(ae,j))w[ee]=j,w[D]=ae,D=ee;else break e}}function n(w){return w.length===0?null:w[0]}function i(w){if(w.length===0)return null;var j=w[0],D=w.pop();if(D!==j){w[0]=D;e:for(var ee=0,ae=w.length,Tt=ae>>>1;ee<Tt;){var ze=2*(ee+1)-1,Jt=w[ze],dt=ze+1,Xt=w[dt];if(0>o(Jt,D))dt<ae&&0>o(Xt,Jt)?(w[ee]=Xt,w[dt]=D,ee=dt):(w[ee]=Jt,w[ze]=D,ee=ze);else if(dt<ae&&0>o(Xt,D))w[ee]=Xt,w[dt]=D,ee=dt;else break e}}return j}function o(w,j){var D=w.sortIndex-j.sortIndex;return D!==0?D:w.id-j.id}if(typeof performance=="object"&&typeof performance.now=="function"){var a=performance;e.unstable_now=function(){return a.now()}}else{var r=Date,l=r.now();e.unstable_now=function(){return r.now()-l}}var s=[],d=[],y=1,v=null,h=3,b=!1,I=!1,C=!1,F=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,u=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function f(w){for(var j=n(d);j!==null;){if(j.callback===null)i(d);else if(j.startTime<=w)i(d),j.sortIndex=j.expirationTime,t(s,j);else break;j=n(d)}}function S(w){if(C=!1,f(w),!I)if(n(s)!==null)I=!0,se(k);else{var j=n(d);j!==null&&yn(S,j.startTime-w)}}function k(w,j){I=!1,C&&(C=!1,m(O),O=-1),b=!0;var D=h;try{for(f(j),v=n(s);v!==null&&(!(v.expirationTime>j)||w&&!pe());){var ee=v.callback;if(typeof ee=="function"){v.callback=null,h=v.priorityLevel;var ae=ee(v.expirationTime<=j);j=e.unstable_now(),typeof ae=="function"?v.callback=ae:v===n(s)&&i(s),f(j)}else i(s);v=n(s)}if(v!==null)var Tt=!0;else{var ze=n(d);ze!==null&&yn(S,ze.startTime-j),Tt=!1}return Tt}finally{v=null,h=D,b=!1}}var x=!1,P=null,O=-1,Z=5,L=-1;function pe(){return!(e.unstable_now()-L<Z)}function Pe(){if(P!==null){var w=e.unstable_now();L=w;var j=!0;try{j=P(!0,w)}finally{j?Yt():(x=!1,P=null)}}else x=!1}var Yt;if(typeof u=="function")Yt=function(){u(Pe)};else if(typeof MessageChannel<"u"){var Jn=new MessageChannel,va=Jn.port2;Jn.port1.onmessage=Pe,Yt=function(){va.postMessage(null)}}else Yt=function(){F(Pe,0)};function se(w){P=w,x||(x=!0,Yt())}function yn(w,j){O=F(function(){w(e.unstable_now())},j)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(w){w.callback=null},e.unstable_continueExecution=function(){I||b||(I=!0,se(k))},e.unstable_forceFrameRate=function(w){0>w||125<w?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):Z=0<w?Math.floor(1e3/w):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(w){switch(h){case 1:case 2:case 3:var j=3;break;default:j=h}var D=h;h=j;try{return w()}finally{h=D}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(w,j){switch(w){case 1:case 2:case 3:case 4:case 5:break;default:w=3}var D=h;h=w;try{return j()}finally{h=D}},e.unstable_scheduleCallback=function(w,j,D){var ee=e.unstable_now();switch(typeof D=="object"&&D!==null?(D=D.delay,D=typeof D=="number"&&0<D?ee+D:ee):D=ee,w){case 1:var ae=-1;break;case 2:ae=250;break;case 5:ae=1073741823;break;case 4:ae=1e4;break;default:ae=5e3}return ae=D+ae,w={id:y++,callback:j,priorityLevel:w,startTime:D,expirationTime:ae,sortIndex:-1},D>ee?(w.sortIndex=D,t(d,w),n(s)===null&&w===n(d)&&(C?(m(O),O=-1):C=!0,yn(S,D-ee))):(w.sortIndex=ae,t(s,w),I||b||(I=!0,se(k))),w},e.unstable_shouldYield=pe,e.unstable_wrapCallback=function(w){var j=h;return function(){var D=h;h=j;try{return w.apply(this,arguments)}finally{h=D}}}})(_c);Dc.exports=_c;var Op=Dc.exports;/**
 * @license React
...
`;function rg(){const[e,t]=T.useState(Hf),[n,i]=T.useState({}),[o,a]=T.useState({}),[r,l]=T.useState({}),[s,d]=T.useState(null),[y,v]=T.useState("idle"),[h,b]=T.useState(!1),[I,C]=T.useState(""),[F,m]=T.useState(""),[u,f]=T.useState(null),[S,k]=T.useState(!1),[x,P]=T.useState([]),[O,Z]=T.useState(null),[L,pe]=T.useState("signals"),[Pe,Yt]=T.useState({leftIdx:1,rightIdx:0}),[Jn,va]=T.useState("emerging"),[se,yn]=T.useState([]),[w,j]=T.useState([]),[D,ee]=T.useState(null),[ae,Tt]=T.useState("idle"),[ze,Jt]=T.useState(Vf),[dt,Xt]=T.useState(""),[Bd,ya]=T.useState(!1),[Vl,Ud]=T.useState(!1),[Sn,Hd]=T.useState(""),[$i,$l]=T.useState([]),[Zt,Xn]=T.useState("idle"),[Vd,ql]=T.useState(!1),[qi,Sa]=T.useState(null),[Gl,Wl]=T.useState(null),[lg,sg]=T.useState("idle"),[Ql,$d]=T.useState({scan:"",launchd:""}),[Gi,xa]=T.useState("idle"),[cg,Kl]=T.useState([]),[qd,Gd]=T.useState({}),[Wd,Qd]=T.useState(new Set),Ea=T.useRef(null),he=ng(),[Kd,Yd]=T.useState(()=>new Date().toLocaleString("it-IT",{dateStyle:"short",timeStyle:"short"})),xe=e.filter(p=>p.active),Yl=xe.filter(p=>!p.fontiOnly),xn=Object.values(r).filter(p=>p==="done"||p==="stale").length,Na=xe.length;T.useEffect(()=>{(async()=>{try{const p=await window.storage.get("signal-state");if(p){const g=JSON.parse(p.value);if(g.results){i(g.results);const N=new Set((g.staleIds||[]).map(String)),A={};for(const H of Object.keys(g.results))g.results[H].startsWith("Errore")?A[H]="error":N.has(String(H))?A[H]="stale":A[H]="done";l(A),g.staleIds&&Kl(g.staleIds)}if(g.prevResults&&a(g.prevResults),g.lastScanTime&&f(g.lastScanTime),g.synthesis&&(d(g.synthesis),v("done")),g.synthesisHistory){const N=g.synthesisHistory.map((A,H,G)=>{if(A.conceptDiff&&!A.conceptDiffs){const Ee=G[H+1],{conceptDiff:De,...Je}=A;return Ee?{...Je,conceptDiffs:{[Ee.id]:De}}:Je}return A});P(N)}g.projects&&yn(g.projects),g.prevProjects&&j(g.prevProjects),g.projectsTime&&ee(g.projectsTime),g.projectSources&&Jt(g.projectSources)}}catch{}})()},[]);const Ae=T.useCallback(async(p={})=>{try{const g=await window.storage.get("signal-state"),A={...g?JSON.parse(g.value):{},...p};await window.storage.set("signal-state",JSON.stringify(A))}catch{}},[]);T.useCallback(async(p={})=>{await Ae({results:n,prevResults:o,lastScanTime:u,synthesis:s,synthesisHistory:x,projects:se,prevProjects:w,projectsTime:D,projectSources:ze,...p})},[n,o,u,s,x,se,w,D,ze,Ae]);const Wi=T.useCallback((p,g)=>g.length>0&&g[0].text===p?g:[{id:`synth_${Date.now()}`,timestamp:Date.now(),text:p,thinkers:xe.map(A=>A.name),conceptDiffs:{}},...g].slice(0,50),[xe]),Qi=T.useCallback(async p=>{var A;if(p.length<2)return p;const g=p[0],N=p[1];if((A=g.conceptDiffs)!=null&&A[N.id])return p;try{const H=await Yf(N.text,g.text),G=[...p];return G[0]={...G[0],conceptDiffs:{...G[0].conceptDiffs||{},[N.id]:H}},P(G),await Ae({synthesisHistory:G}),G}catch(H){return console.error("[concept-diff auto]",H),p}},[Ae]),Jl=T.useCallback(async(p,g)=>{try{await navigator.clipboard.writeText(p)}catch{const N=document.createElement("textarea");N.value=p,document.body.appendChild(N),N.select(),document.execCommand("copy"),document.body.removeChild(N)}Z(g),setTimeout(()=>Z(null),2e3)},[]);T.useCallback(async p=>{const g=x.filter(N=>N.id!==p);P(g),await Ae({synthesisHistory:g})},[x,Ae]);const ba=T.useCallback(async()=>{xa("loading");const p="/signal-brief/ai/";try{const[g,N]=await Promise.all([fetch(`${p}logs/auto-scan.log`,{cache:"no-cache"}),fetch(`${p}logs/launchd-out.log`,{cache:"no-cache"})]),A=g.ok?await g.text():"",H=N.ok?await N.text():"";$d({scan:A,launchd:H}),xa("done")}catch(g){console.error("[logs]",g),xa("error")}},[]);T.useEffect(()=>{L==="log"&&ba()},[L,ba]);const Xl=T.useCallback(p=>{if(!p)return;const g=p.trim().toLowerCase();if(!g)return;const N=e.find(A=>{const H=A.name.toLowerCase();return H===g||H.includes(g)||g.includes(H)});N&&(pe("signals"),k(!1),setTimeout(()=>{const A=document.getElementById(`thinker-${N.id}`);A&&(A.scrollIntoView({behavior:"smooth",block:"start"}),A.classList.add("thinker-card-highlight"),setTimeout(()=>A.classList.remove("thinker-card-highlight"),1800))},60))},[e]),Jd=(p,g)=>{if(!p||!g)return 0;const N=new Set(p.toLowerCase().split(/\s+/)),A=new Set(g.toLowerCase().split(/\s+/));return[...N].filter(G=>A.has(G)).length/Math.max(N.size,A.size)},Zl=p=>!o[p]||!n[p]?!1:Jd(o[p],n[p])<.72;xe.filter(p=>r[p.id]==="done"&&Zl(p.id)).length;const es=e.length>0&&e.every(p=>p.active),Xd=()=>{h||t(p=>p.map(g=>({...g,active:!es})))},Ia=()=>{I.trim()&&(t(p=>[...p,{id:Date.now(),name:I.trim(),handle:F.trim()||"@?",domain:"Custom",active:!0}]),C(""),m(""))},ts=()=>{const p=dt.trim();if(!p||ze.includes(p))return;const g=[...ze,p];Jt(g),Xt(""),Ae({projectSources:g})},Zd=p=>{const g=ze.filter(N=>N!==p);Jt(g),Ae({projectSources:g})},[ep,ns]=T.useState(null),Ki=T.useCallback(async(p,g)=>{Tt("loading"),ns(null);try{const N=await Kf(g,p,ze);j(se),yn(N);const A=Date.now();ee(A),Tt("done"),await Ae({projects:N,prevProjects:se,projectsTime:A})}catch(N){console.error("[Signal.Brief] fetchProjects error:",N),Tt("error"),ns(N.message)}},[ze,Ae,se]),tp=T.useCallback(async()=>{if(xe.length===0)return;pe("signals"),b(!0),d(null),v("idle"),a(U=>({...U,...n}));const p={...n},g={};for(const U of xe){const ce=p[U.id];ce&&!ce.startsWith("Errore")&&(g[U.id]=ce)}const N={};xe.forEach(U=>{N[U.id]="loading"}),l(N),i(g);const A={...g},H=[],G={},Ee=2,De=U=>new Promise(ce=>setTimeout(ce,U));for(let U=0;U<xe.length;U+=Ee){const ce=xe.slice(U,U+Ee);await Promise.all(ce.map(async Me=>{try{const V=await Qf(Me);A[Me.id]=V,i(re=>({...re,[Me.id]:V})),l(re=>({...re,[Me.id]:"done"}))}catch(V){const re=g[Me.id]!=null,me=V.message||V.name||(typeof V=="string"?V:"errore sconosciuto");G[Me.id]=me,re?(H.push(String(Me.id)),l(Y=>({...Y,[Me.id]:"stale"}))):(A[Me.id]=`Errore: ${me}`,i(Y=>({...Y,[Me.id]:`Errore: ${me}`})),l(Y=>({...Y,[Me.id]:"error"})))}})),U+Ee<xe.length&&await De(1200)}Kl(H),Gd(G);const Je=Wf(A),$e=Je?Date.now():u;Je&&(f($e),Yd(new Date().toLocaleString("it-IT",{dateStyle:"short",timeStyle:"short"}))),await Ae({results:A,prevResults:p,lastScanTime:$e,synthesis:s,synthesisHistory:x,staleIds:H}),b(!1);const _e=Yl.filter(U=>A[U.id]&&!A[U.id].startsWith("Errore")).map(U=>({name:U.name,domain:U.domain,content:A[U.id]}));if(_e.length>=2){v("loading");try{const U=await xc(_e);d(U),v("done");const ce=Wi(U,x);P(ce),await Ae({results:A,prevResults:p,lastScanTime:$e,synthesis:U,synthesisHistory:ce}),Qi(ce),Ki(U,_e)}catch{v("error")}}},[xe,n,Ae,s,x,Wi,u,Ki,Qi]),np=T.useCallback(async()=>{const p=Yl.filter(g=>r[g.id]==="done"||r[g.id]==="stale").map(g=>({name:g.name,domain:g.domain,content:n[g.id]}));if(!(p.length<2)){v("loading");try{const g=await xc(p);d(g),v("done");const N=Wi(g,x);P(N),await Ae({synthesis:g,synthesisHistory:N}),Qi(N),Ki(g,p)}catch(g){d(`Errore nella sintesi: ${g.message}`),v("error")}}},[xe,r,n,Ae,x,Wi,Ki,Qi]),[is,ip]=T.useState(nn.boardId),[os,op]=T.useState(nn.provisioned!==!1),as=T.useCallback(async()=>{if(!Sn.trim())return;$l([]),Sa(null),Wl(null);let p=is;if(!os&&Wn){Xn("provisioning");try{const g=await fetch(`/admin/api/themes/${Wn}/provision-council`,{method:"POST"}),N=await g.json();if(!g.ok||!N.ok)throw new Error(N.error||`HTTP ${g.status}`);p=N.boardId,ip(p),op(!0)}catch(g){console.error("[council] provisioning failed",g),Xn("error");return}}Xn("loading"),ql(!1);try{await Jf(Sn,s,(g,N)=>{if(g==="session_started"&&N.session_id&&Wl(N.session_id),g==="sage_speaks"&&N.content&&$l(A=>[...A,{name:N.persona_name,icon:N.persona_icon,color:N.persona_color,content:N.content}]),g==="moderator_synthesis"&&N.content&&Sa(N.content),g==="moderator"){const A=N.content||N.decision||N.synthesis||"";A&&Sa(A)}},p),Xn("done")}catch(g){console.error("[council]",g),g.message==="auth_required"&&ql(!0),Xn("error")}},[Sn,s,is,os]),ap=xn>=2&&!h&&y!=="loading",rs=Object.keys(n).length>0,ls="Disponibile solo in locale (richiede Claude CLI)",rp=xe.filter(p=>{if(!r[p.id])return!1;if(S){const g=r[p.id];return(g==="done"||g==="stale")&&Zl(p.id)}return!0});return c.jsxs(c.Fragment,{children:[c.jsx("style",{children:ag}),c.jsxs("div",{className:"dashboard",children:[c.jsx("div",{className:"scanline"}),c.jsxs("header",{className:"header",children:[c.jsxs("div",{className:"header-top",children:[c.jsxs("div",{className:"header-left",children:[c.jsx("div",{className:"logo",style:{cursor:"pointer"},onClick:()=>ya(!0),dangerouslySetInnerHTML:{__html:ve.nameHtml}}),c.jsx("div",{className:"tagline",children:ve.tagline})]}),c.jsxs("div",{className:"header-right",children:[u&&c.jsxs("span",{className:"timestamp",children:["ultimo: ",Kd]}),c.jsx("button",{className:"btn btn-synthesis btn-small",onClick:np,disabled:!ap||!0,title:ls,children:"◈ Synth"}),c.jsx("button",{className:"btn btn-ghost btn-small",onClick:()=>{if(!Ea.current){const g=new Audio(`/signal-brief/ai/podcast/episodes/${new Date().toISOString().slice(0,10)}.mp3${nr}`);g.onerror=()=>{g.src=`/signal-brief/ai/podcast/episodes/2026-04-12.mp3${nr}`,g.play()},Ea.current=g}const p=Ea.current;p.paused?p.play():p.pause()},title:"Ascolta l'ultimo episodio",children:"🎙 Podcast"}),c.jsx("a",{className:"btn btn-ghost btn-small",href:`/signal-brief/ai/podcast/${nr}`,title:"Archivio puntate con testo, sintesi, comparazione e fonti",style:{textDecoration:"none",display:"inline-flex",alignItems:"center"},children:"☰ Archivio"}),c.jsx("button",{className:"btn btn-primary",onClick:()=>tp(),disabled:h||xe.length===0||!0,title:ls,children:h?`Scanning ${xn}/${Na}…`:"▶ Scan"})]})]}),c.jsxs("nav",{className:"tab-bar",children:[c.jsxs("button",{className:`tab-btn ${L==="signals"?"active":""}`,onClick:()=>pe("signals"),children:["Segnali",xn>0&&c.jsx("span",{className:"tab-badge",children:xn})]}),c.jsxs("button",{className:`tab-btn ${L==="projects"?"active":""}`,onClick:()=>pe("projects"),children:["Progetti",se.length>0&&c.jsx("span",{className:"tab-badge",children:se.length})]}),c.jsxs("button",{className:`tab-btn ${L==="history"?"active":""}`,onClick:()=>pe("history"),children:["Cronologia",x.length>0&&c.jsx("span",{className:"tab-badge",children:x.length})]}),c.jsx("button",{className:`tab-btn ${L==="log"?"active":""}`,onClick:()=>pe("log"),children:"▤ Log"}),c.jsx("button",{className:`tab-btn ${L==="config"?"active":""}`,onClick:()=>pe("config"),children:"⚙ Configurazione"})]})]}),c.jsxs("div",{className:"tab-content",children:[L==="signals"&&c.jsxs(c.Fragment,{children:[h&&c.jsx("div",{className:"progress-bar",children:c.jsx("div",{className:"progress-fill",style:{width:`${Na>0?xn/Na*100:0}%`}})}),(s||y==="loading")&&c.jsxs("div",{className:"synthesis-panel",children:[c.jsxs("div",{className:"synthesis-header",children:[c.jsx("span",{className:"synthesis-label",children:"◈ Cross-Synthesis"}),c.jsx("span",{className:"synthesis-title",children:y==="loading"?"Elaborazione…":"Temi emergenti trasversali"}),y==="done"&&x.length>0&&c.jsx("span",{className:"timestamp",children:new Date(x[0].timestamp).toLocaleString("it-IT",{dateStyle:"short",timeStyle:"short"})}),y==="done"&&c.jsxs("div",{className:"synthesis-actions",children:[c.jsx("button",{className:"btn-listen",onClick:()=>he.playSingle("Cross-Synthesis",s),title:"Ascolta",children:"🔊"}),c.jsx("button",{className:"btn btn-ghost btn-small",onClick:()=>Ud(p=>!p),title:"Chiedi ai thinkers",style:Vl?{background:"#ede9fe",color:"#7c3aed",borderColor:"#d8b4fe"}:{},children:"📡 Chiedi"}),c.jsx("button",{className:"btn btn-ghost btn-small",onClick:()=>Jl(s,"synth"),children:O==="synth"?"Copiato ✓":"Copia ❐"})]})]}),y==="loading"?c.jsxs("div",{className:"card-loading-state",children:[c.jsx("div",{className:"spinner"}),"Analisi in corso…"]}):c.jsx("div",{className:"synthesis-body",dangerouslySetInnerHTML:{__html:Zf(cn(s),xe)}}),Vl&&y==="done"&&c.jsxs("div",{className:"council-panel",children:[c.jsxs("div",{className:"council-header",children:[Gl?c.jsx("a",{className:"council-label",href:`https://stelle-972218119922.europe-west1.run.app/?context=session:${Gl}`,target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",cursor:"pointer"},children:"📡 Assemblea Signal-Brief ↗"}):c.jsx("span",{className:"council-label",children:"📡 Assemblea Signal-Brief"}),c.jsx("span",{style:{fontFamily:"IBM Plex Mono,monospace",fontSize:10,color:"var(--sb-text-muted)"},children:"21 thinker · Summon Stars"})]}),c.jsxs("div",{className:"council-input-row",children:[c.jsx("input",{className:"council-input",placeholder:"Fai una domanda ai thinkers...",value:Sn,onChange:p=>Hd(p.target.value),onKeyDown:p=>p.key==="Enter"&&as(),disabled:Zt==="loading"||Zt==="provisioning"}),c.jsx("button",{className:"btn btn-primary btn-small",onClick:as,disabled:Zt==="loading"||Zt==="provisioning"||!Sn.trim(),children:Zt==="provisioning"?"Creazione assemblea…":Zt==="loading"?"In deliberazione…":"Chiedi"})]}),$i.length>0&&c.jsx("div",{style:{maxHeight:400,overflowY:"auto"},children:$i.map((p,g)=>c.jsxs("div",{className:"council-msg",children:[c.jsxs("div",{className:"council-msg-name",style:{color:p.color},children:[p.icon," ",p.name]}),c.jsx("div",{children:p.content})]},g))}),qi&&c.jsxs("div",{className:"council-synthesis",children:[c.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between"},children:[c.jsx("div",{className:"council-synthesis-label",children:"Sintesi del moderatore"}),c.jsxs("div",{style:{display:"flex",gap:4},children:[c.jsx("button",{className:"btn-listen",onClick:()=>{const p=$i.map(g=>`${g.name}: ${g.content}`).join(`
