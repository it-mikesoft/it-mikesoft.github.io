...
`);S.push({title:"Progetti Emergenti",text:k,type:"projects"})}y(S)},[y]),T=w.useCallback((F,m)=>{y([{title:F,text:m,type:"single"}])},[y]);return w.useEffect(()=>()=>speechSynthesis.cancel(),[]),{isPlaying:e,currentChapter:n,chapters:o,playAll:I,playSingle:T,pause:v,resume:h,stop:p,skipForward:b}}const rr=Kn?`?theme=${Kn}`:"",cg=`
